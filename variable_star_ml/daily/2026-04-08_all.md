...
**Title Relevance Reason**:  
Protostellar variability is directly about stellar variability, though not the main classical variable-star classes or ML inference focus.
...
**Title Relevance Reason**:  
Binary star evolution is relevant background, but not focused on eclipsing binaries, light curves, or variability inference.
...
**Title Relevance Reason**:  
Periodicity and long-term trend analysis are relevant time-series concepts, but the source is a blazar, not a variable star.
...
**Title Relevance Reason**:  
Optical polarimetry of an accreting X-ray binary involves a variable stellar system, but not the core variable-star classes emphasized.
...
**Title Relevance Reason**:  
Photometric time series appears in the title, but for transiting exoplanets rather than stellar variability classes.
...
**Title Relevance Reason**:  
Binary stellar system involving a millisecond pulsar and subdwarf B star; binary stars are relevant background but not variable-star inference.
...
**Title Relevance Reason**:  
Self-supervised transfer learning in astronomy is methodologically relevant, but focused on radio astronomy generally rather than variable stars.
...
**Title Relevance Reason**:  
Pulses from the Crab pulsar involve time variability, but this is not about variable stars in the usual sense.
...
**Title Relevance Reason**:  
Pulsar timing and pulse-shape changes involve time variability, but not variable stars in the intended sense.
...
**Title Relevance Reason**:  
Blazar flaring and variability are time-domain phenomena, but not variable stars.
...
**Title Relevance Reason**:  
Deep learning of burst morphologies is methodologically relevant to time-series classification, but the domain is FRBs not variable stars.
...
**Title Relevance Reason**:  
Neural-network framework in astronomy, but applied to cluster completeness, not variable stars.
...
**Title Relevance Reason**:  
Long-baseline transit timing and transmission spectroscopy involve photometric time series, but for exoplanets rather than variable stars.
...
**Title Relevance Reason**:  
Generative models on stellar streams use ML with stellar data, but not variable stars.
...
**Title Relevance Reason**:  
Metallicity is a secondary keyword, but this is about galaxy-scale metallicity gradients, not variable stars.
...
**Title Relevance Reason**:  
Intranight variability in a BL Lac is time-domain astronomy, but not variable stars.
...
**Title Relevance Reason**:  
Concerns failed supernova progenitors and neighboring stars, only marginally related to stellar variability.
...
**Title Relevance Reason**:  
Machine learning interpretability is relevant methodologically, but the target is CMB maps rather than variable stars.
...
**Title Relevance Reason**:  
Transit timing and transmission spectroscopy for an exoplanet, involving time series but not stellar variability.
...
**Title Relevance Reason**:  
A variable gamma-ray source, but not a variable star study.
...
**Title Relevance Reason**:  
X-ray binaries are variable systems, but this is about accretion winds rather than stellar light-curve analysis.
...
**Title Relevance Reason**:  
Metallicity and massive stars are relevant stellar properties, but this is cluster chemical enrichment rather than variable stars.
...
**Title Relevance Reason**:  
Temporal variation is present, but in a tidal disruption event rather than variable stars.
...
**Title Relevance Reason**:  
Pre-main-sequence stellar evolution, rotation, and accretion; only loosely connected to variability.
...
**Title Relevance Reason**:  
Neural networks applied to neutron star observables, methodologically related but not about variable stars.
...
**Title Relevance Reason**:  
Solar convection modeling concerns stellar physics, but not variability or light-curve inference.
...
**Title Relevance Reason**:  
Chemical composition and explosions in Perseus cluster, not variable-star focused.
...
**Title Relevance Reason**:  
Brown dwarf atmospheric retrieval; stellar objects but not variable-star light-curve studies.
...
**Title Relevance Reason**:  
Compact-star companions and gravitational waves, only very indirectly related to stellar variability.
...
**Title Relevance Reason**:  
Stellar populations in galaxies, only distantly connected to stars, not variability studies.
...
**Title Relevance Reason**:  
Symbolic regression and cosmology; ML is present but not tied to variable stars.
...
**Title Relevance Reason**:  
General mass-density distribution of astronomical objects, not variable-star focused.
...
**Title Relevance Reason**:  
Training/calibration for photometric redshifts uses ML-like ideas but not for variable stars.
...
**Title Relevance Reason**:  
Reinforcement learning for wavefront control is ML-related but irrelevant to variable stars.
...
**Title Relevance Reason**:  
Stellar halos in cosmological simulations involve stars broadly, but not variability.
...
**Title Relevance Reason**:  
Magnetar birefringence, involving compact stars but not variable-star studies.
...
**Title Relevance Reason**:  
AGN-driven metallicity enrichment mentions metallicity but not variable stars.
...
**Title Relevance Reason**:  
About photographic plate transients and geomagnetic effects, not stellar variability studies.
...
**Title Relevance Reason**:  
Gravitational-wave inference, unrelated to variable stars or light-curve modeling.
...
**Title Relevance Reason**:  
Compact-object mergers in AGN disks, not variable stars.
...
**Title Relevance Reason**:  
Quiescent galaxy number densities, unrelated to variable stars.
...
**Title Relevance Reason**:  
Star formation histories of galaxies, not stellar variability.
...
**Title Relevance Reason**:  
Gamma-ray emission from AGN, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark-matter filaments, unrelated to variable stars.
...
**Title Relevance Reason**:  
Planetary dynamics and resonant chains, not variable stars.
...
**Title Relevance Reason**:  
Short GRBs and merger rates, unrelated to variable stars.
...
**Title Relevance Reason**:  
Exoplanet atmospheric spectroscopy, not variable stars.
...
**Title Relevance Reason**:  
Relativistic plasma theory, unrelated to variable stars.
...
**Title Relevance Reason**:  
Neutron star mergers and r-process production, not variable stars.
...
**Title Relevance Reason**:  
Tests of gravity near black holes, unrelated to variable stars.
...
**Title Relevance Reason**:  
Cosmic baryon structures, not variable stars.
...
**Title Relevance Reason**:  
Cosmological parameter tension, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dust polarization in disks, unrelated to variable stars.
...
**Title Relevance Reason**:  
Radio counterpart to a supernova, not variable stars.
...
**Title Relevance Reason**:  
Gas inflow in galaxies, unrelated to variable stars.
...
**Title Relevance Reason**:  
Supernova radiative-transfer modeling, not variable stars.
...
**Title Relevance Reason**:  
Gas-giant formation and composition, unrelated to variable stars.
...
**Title Relevance Reason**:  
Fourier methods for ring-like images, no clear connection to variable stars.
...
**Title Relevance Reason**:  
Primordial non-Gaussianity and galaxy surveys, unrelated to variable stars.
...
**Title Relevance Reason**:  
Chemistry of young stars and disks, not variable-star analysis.
...
**Title Relevance Reason**:  
Exomoon search and ephemerides, unrelated to variable stars.
...
**Title Relevance Reason**:  
Strong lensing and dark matter halos, not variable stars.
...
**Title Relevance Reason**:  
Early-universe radiation injection, unrelated to variable stars.
...
**Title Relevance Reason**:  
Solar coronal streamer blobs, unrelated to variable stars.
...
**Title Relevance Reason**:  
Polarization calibration for megamasers, unrelated to variable stars.
...
**Title Relevance Reason**:  
Cosmology with supernovae and BAO, unrelated to variable-star analysis.
...
**Title Relevance Reason**:  
Radio galaxy evolution, not variable stars.
...
**Title Relevance Reason**:  
Neutron-star matter theory, unrelated to variable stars.
...
**Title Relevance Reason**:  
HI absorption toward a quasar, unrelated to variable stars.
...
**Title Relevance Reason**:  
Binary black-hole merger environments, unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy HI depletion times, not variable stars.
...
**Title Relevance Reason**:  
Galaxy clustering and halo connections, unrelated to variable stars.
...
**Title Relevance Reason**:  
Blazar catalog, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark matter subhalo dynamics, unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy outflow spectroscopy, not variable stars.
...
**Title Relevance Reason**:  
Neutron star merger ejecta modeling, unrelated to variable stars.
...
**Title Relevance Reason**:  
Detector instrumentation for gravitational waves, unrelated to variable stars.
...
**Title Relevance Reason**:  
Kilonova spectral modeling, not variable stars.
...
**Title Relevance Reason**:  
Axion signals in supernovae, unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy cluster lensing selection bias, unrelated to variable stars.
...
**Title Relevance Reason**:  
Concordance cosmology tests, not variable stars.
...
**Title Relevance Reason**:  
Solar gamma-ray comment paper, unrelated to variable stars.
...
**Title Relevance Reason**:  
Pre-supernova neutrino support software, not variable stars.
...
**Title Relevance Reason**:  
Planet migration and debris disks, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dense-core spectroscopy survey, unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy spectra and parity tests, unrelated to variable stars.
...
**Title Relevance Reason**:  
Simulation code optimization, unrelated to variable stars.
...
**Title Relevance Reason**:  
Lyman-alpha forest and dark matter, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dual quasar confirmation, not variable stars.
...
**Title Relevance Reason**:  
Star-planet magnetic interactions in exoplanets, not variable-star studies.
...
**Title Relevance Reason**:  
Dark matter with gravitational-wave detector, unrelated to variable stars.
...
**Title Relevance Reason**:  
Instrument sensitivity calibration, unrelated to variable stars.
...
**Title Relevance Reason**:  
Black hole metric distinguishability with EHT, not variable stars.
...
**Title Relevance Reason**:  
Rotational dynamics near resonances, unrelated to variable stars.
...
**Title Relevance Reason**:  
Gravitational mirroring near compact objects, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark matter model for gamma-ray excess, unrelated to variable stars.
...
**Title Relevance Reason**:  
Plasma instability resolution study, unrelated to variable stars.
...
**Title Relevance Reason**:  
Gravitational waves from scalar-field perturbations, unrelated to variable stars.
...
**Title Relevance Reason**:  
Inflationary cosmology, not variable stars.
...
**Title Relevance Reason**:  
Accretion torus around black holes, unrelated to variable stars.
...
**Title Relevance Reason**:  
Space plasma instabilities, not variable stars.
...
**Title Relevance Reason**:  
Molecular quantum chemistry, unrelated to variable stars.
...
**Title Relevance Reason**:  
Detector noise budget, unrelated to variable stars.
...
**Title Relevance Reason**:  
GPU neighbor search software, unrelated to variable stars.
...
**Title Relevance Reason**:  
Field-theory gravitational potential work, unrelated to variable stars.
...
**Title Relevance Reason**:  
Gravitational-wave population statistics, not variable stars.
...
**Title Relevance Reason**:  
Bispectrum theory, unrelated to variable stars.
...
**Title Relevance Reason**:  
BBN photon distributions, unrelated to variable stars.
...
**Title Relevance Reason**:  
Spectral imaging for CMB instrument data, unrelated to variable stars.
...
**Title Relevance Reason**:  
Strong lensing with JWST, unrelated to variable stars.
...
**Title Relevance Reason**:  
Inflation model implications, not variable stars.
...
**Title Relevance Reason**:  
Chemical evolution of galaxies, unrelated to variable stars.
...
**Title Relevance Reason**:  
Black hole-neutron star mergers, unrelated to variable stars.
...
**Title Relevance Reason**:  
Clumpy galaxies in JADES, unrelated to variable stars.
...
**Title Relevance Reason**:  
Blazars as neutrino sources, unrelated to variable stars.
...
**Title Relevance Reason**:  
Fuzzy dark matter and globular clusters, unrelated to variable stars.
...
**Title Relevance Reason**:  
X-ray supernova analysis pipeline, not variable stars.
...
**Title Relevance Reason**:  
Interacting dark energy and superradiance, unrelated to variable stars.
...
**Title Relevance Reason**:  
IGM transmittance for distant sources, unrelated to variable stars.
...
**Title Relevance Reason**:  
Milky Way dark matter density profiles, unrelated to variable stars.
...
**Title Relevance Reason**:  
Odd Radio Circle interpretation, unrelated to variable stars.
...
**Title Relevance Reason**:  
Protostellar outflows and disk structures, not variable stars.
...
**Title Relevance Reason**:  
Supernova progenitor constraints, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark galaxy predictions, unrelated to variable stars.
...
**Title Relevance Reason**:  
Late-time radio observations of a supernova, not variable stars.
...
**Title Relevance Reason**:  
High-redshift galaxy spectroscopy, unrelated to variable stars.
...
**Title Relevance Reason**:  
Accreted stellar halos around galaxies, unrelated to variable stars.
...
**Title Relevance Reason**:  
Alternative cosmology with negative mass, unrelated to variable stars.
...
**Title Relevance Reason**:  
Signal processing language and HDL generation, no clear variable-star connection.
...
**Title Relevance Reason**:  
Galactic electron density model, unrelated to variable stars.
...
**Title Relevance Reason**:  
FRB scattering through the CGM, unrelated to variable stars.
...
**Title Relevance Reason**:  
Coronal electron distributions, unrelated to variable stars.
...
**Title Relevance Reason**:  
Triggered star formation in a protocluster, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark energy physics, not variable stars.
...
**Title Relevance Reason**:  
Spectroscopic redshifts for gravitational lenses, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark energy parameterization and CMB smoothing, unrelated to variable stars.
...
**Title Relevance Reason**:  
Gauss-Bonnet inflation theory, unrelated to variable stars.
...
**Title Relevance Reason**:  
Gas motions in filaments, unrelated to variable stars.
...
**Title Relevance Reason**:  
Gravitational waveform resummation, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark matter velocity distributions for direct detection, unrelated to variable stars.
...
**Title Relevance Reason**:  
Gravitational Raman scattering in higher dimensions, unrelated to variable stars.
...
**Title Relevance Reason**:  
Astronomy education with LLMs, unrelated to variable stars.
...
**Title Relevance Reason**:  
Symmetron fifth-force profiles, unrelated to variable stars.
...
**Title Relevance Reason**:  
Axion-like dark matter detectability in GW detectors, unrelated to variable stars.
...
**Title Relevance Reason**:  
Primordial black hole evaporation, unrelated to variable stars.
