...
**Title Relevance Reason**:  
Astronomical time-series model selection is methodologically relevant to light-curve analysis, though not explicitly for variable stars.
...
**Title Relevance Reason**:  
Outbursting protostar is a variable stellar object, though not clearly focused on ML or general variable-star light-curve inference.
...
**Title Relevance Reason**:  
Nova outburst is a variable/transient stellar phenomenon, though not centered on light-curve modeling or ML.
...
**Title Relevance Reason**:  
Photometric metallicities for stars overlaps with stellar physical inference from photometry, but not specifically variable stars.
...
**Title Relevance Reason**:  
Stellar photometry is relevant to observing stars, but title does not indicate variability or light-curve analysis.
...
**Title Relevance Reason**:  
Transit-timing variations in an exoplanet system involve stellar light curves, but not variable-star classification/modeling.
...
**Title Relevance Reason**:  
Photometric metallicities overlap with photometric physical inference, but the target is a stellar stream, not variable stars.
...
**Title Relevance Reason**:  
Real-time photometric classifier using ML, but for superluminous supernovae rather than variable stars.
...
**Title Relevance Reason**:  
Machine learning for stellar chemical diagnostics overlaps with stellar physical inference, but not variable-star specific.
...
**Title Relevance Reason**:  
Variability metrics and cadence study, but focused on AGN rather than variable stars.
...
**Title Relevance Reason**:  
Algorithmic detection of flares in repeating FRBs; time-series methodology but not stellar variability.
...
**Title Relevance Reason**:  
Search for AGN flares in time-domain survey data; time-series overlap but not variable stars.
...
**Title Relevance Reason**:  
Contains accretion variability, but for circumbinary disks rather than stellar light-curve variability.
...
**Title Relevance Reason**:  
Stellar activity indices in FGK stars relate to stellar variability broadly, but not variable-star light curves.
...
**Title Relevance Reason**:  
Stellar chemical diagnostics in binaries; stellar inference but not variable-star light curves.
...
**Title Relevance Reason**:  
Photometric properties of protoplanetary disks, not stellar variability or light curves.
...
**Title Relevance Reason**:  
ML classification of galaxy morphologies; only secondary-method overlap, not variable stars.
...
**Title Relevance Reason**:  
Deep learning localization for GRBs; method overlap only, not variable stars.
...
**Title Relevance Reason**:  
Type Ia supernova modeling; transient stellar explosion but not variable-star focus.
...
**Title Relevance Reason**:  
Improving radial velocity precision is stellar-observation adjacent, but not about variability/light curves.
...
**Title Relevance Reason**:  
Machine learning and uncertainty in weak lensing, but not on stars or variability.
...
**Title Relevance Reason**:  
Young stellar population structure/kinematics, not variable-star time-series analysis.
...
**Title Relevance Reason**:  
Neural-network surrogate modeling, but for gravitational waveforms rather than stellar variability.
...
**Title Relevance Reason**:  
Mass-modeling stellar systems, but not variable-star observation or classification.
...
**Title Relevance Reason**:  
AI and morphology in cosmology, not stellar variability.
...
**Title Relevance Reason**:  
Machine learning for galaxy star formation regulation, not stellar variability.
...
**Title Relevance Reason**:  
Neutron star spectral properties at low accretion rates; not variable-star light curves.
...
**Title Relevance Reason**:  
Symbolic regression for galaxy profile fitting; ML method but unrelated to stellar variability.
...
**Title Relevance Reason**:  
X-ray binary disk truncation study; some time-domain flavor but not variable-star inference.
...
**Title Relevance Reason**:  
Companion/orbit statistical relations; stellar systems adjacent but not variability-focused.
...
**Title Relevance Reason**:  
Planetary nebula kinematics and stream photometry, not variable-star studies.
...
**Title Relevance Reason**:  
Neutron star magnetosphere plasma distribution, not variable-star time-series work.
...
**Title Relevance Reason**:  
Relativistic star tidal perturbations, but not observational stellar variability.
...
**Title Relevance Reason**:  
Neutron star oscillation modes, but not observational variable-star studies.
...
**Title Relevance Reason**:  
Binary neutron star merger physics; not about stellar variability or variable-star light curves.
...
**Title Relevance Reason**:  
Gravitational-wave black hole lensing; unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy gas accretion simulations; unrelated to variable stars.
...
**Title Relevance Reason**:  
Instrumentation for spectroscopy/wavefront control, not variable-star analysis.
...
**Title Relevance Reason**:  
Stellar shells and streams in galaxies, not stellar variability.
...
**Title Relevance Reason**:  
Cluster-core radio bubble study; unrelated to variable stars.
...
**Title Relevance Reason**:  
GRB follow-up observations, not variable stars.
...
**Title Relevance Reason**:  
Solar wind plasma waves, unrelated to variable-star light curves.
...
**Title Relevance Reason**:  
Cosmological halo bias fitting; not relevant to variable stars.
...
**Title Relevance Reason**:  
Accretion disk structure around compact objects, not variable-star classification/modeling.
...
**Title Relevance Reason**:  
Cosmological gravity test with kSZ effect; unrelated to variable stars.
...
**Title Relevance Reason**:  
X-ray transient from central engine activity, not variable stars.
...
**Title Relevance Reason**:  
Ocean model for climate GCMs; unrelated to astrophysical variable stars.
...
**Title Relevance Reason**:  
GRB afterglow / fast blue transient, not variable stars.
...
**Title Relevance Reason**:  
Planet formation and migration modeling; unrelated to variable stars.
...
**Title Relevance Reason**:  
Europa surface thermophysics, not stellar variability.
...
**Title Relevance Reason**:  
Galactic merger history study, unrelated to variable stars.
...
**Title Relevance Reason**:  
Neutrino mass forecasts from Roman; not variable stars.
...
**Title Relevance Reason**:  
Cosmogenic neutrino emissions, unrelated to stellar variability.
...
**Title Relevance Reason**:  
Galactic outflow gas survey, not variable stars.
...
**Title Relevance Reason**:  
Compact galaxy population in DESI; unrelated to variable stars.
...
**Title Relevance Reason**:  
Inflation/cosmology constraints; unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy merger model, not variable stars.
...
**Title Relevance Reason**:  
IGM ionization and metallicity, unrelated to stars/light curves.
...
**Title Relevance Reason**:  
Dark galaxy candidate catalog; unrelated to variable stars.
...
**Title Relevance Reason**:  
Black hole accretion flow modeling, not variable stars.
...
**Title Relevance Reason**:  
Fermi-LAT source identification, unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy population modeling for Euclid; not variable stars.
...
**Title Relevance Reason**:  
Particle acceleration at shocks, unrelated to variable stars.
...
**Title Relevance Reason**:  
Infrared observing background calibration, not variable-star science.
...
**Title Relevance Reason**:  
Primordial black holes and dark matter, unrelated to variable stars.
...
**Title Relevance Reason**:  
Star formation core fragmentation, not stellar variability studies.
...
**Title Relevance Reason**:  
Dual AGN activity, not variable stars.
...
**Title Relevance Reason**:  
Galaxy mergers and star formation, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark matter cosmology, not variable stars.
...
**Title Relevance Reason**:  
High-contrast imaging R&D, unrelated to variable stars.
...
**Title Relevance Reason**:  
Gravitational-wave follow-up strategy, unrelated to variable stars.
...
**Title Relevance Reason**:  
Solar energetic particle radiation doses, unrelated to variable stars.
...
**Title Relevance Reason**:  
Asteroid photometry and characterization, not variable stars.
...
**Title Relevance Reason**:  
Galaxy quenching pathways, unrelated to variable stars.
...
**Title Relevance Reason**:  
Inflation theory, unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy bulge ages and bar evolution, not variable stars.
...
**Title Relevance Reason**:  
Neutrino self-interactions and large-scale structure, unrelated to variable stars.
...
**Title Relevance Reason**:  
Exoplanet atmosphere spectroscopy, not variable stars.
...
**Title Relevance Reason**:  
Planet interior structure model, unrelated to variable stars.
...
**Title Relevance Reason**:  
Gravitational-wave lensing theory, not variable stars.
...
**Title Relevance Reason**:  
Meteorite microstructure analysis, unrelated to variable stars.
...
**Title Relevance Reason**:  
Stochastic inflation theory, unrelated to variable stars.
...
**Title Relevance Reason**:  
Binary black hole mass distribution, not variable stars.
...
**Title Relevance Reason**:  
Neutrino mixing bounds, unrelated to variable stars.
...
**Title Relevance Reason**:  
Inflaton regeneration theory, unrelated to variable stars.
...
**Title Relevance Reason**:  
Freeze-in dark matter theory; unrelated to variable stars.
...
**Title Relevance Reason**:  
Orbital control theory for spacecraft, not variable stars.
...
**Title Relevance Reason**:  
Boson star-black hole binaries, unrelated to variable stars.
...
**Title Relevance Reason**:  
Cosmic strings, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark-energy/cosmology topic, not variable stars.
...
**Title Relevance Reason**:  
Lyman-alpha line profiles in galaxies/IGM, unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy size-mass relation, unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy group/cluster gas fractions, not variable stars.
...
**Title Relevance Reason**:  
Galaxy stellar mass function and SFR evolution, unrelated to variable stars.
...
**Title Relevance Reason**:  
Adaptive optics system development, unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy morphology and cosmic web evolution, not variable stars.
...
**Title Relevance Reason**:  
SMBH binary mergers in PTA data, unrelated to variable stars.
...
**Title Relevance Reason**:  
JWST interferometer image reconstruction, not variable stars.
...
**Title Relevance Reason**:  
Lyman-alpha emitters and reionization, unrelated to variable stars.
...
**Title Relevance Reason**:  
High-redshift radio galaxy imaging, not variable stars.
...
**Title Relevance Reason**:  
Dual/lensed AGN spectroscopy, unrelated to variable stars.
...
**Title Relevance Reason**:  
Primordial non-Gaussianity with quasars/CMB lensing, unrelated to variable stars.
...
**Title Relevance Reason**:  
Cosmic expansion measurement with DESI, not variable stars.
...
**Title Relevance Reason**:  
Asteroid polarimetry/albedo, unrelated to variable stars.
...
**Title Relevance Reason**:  
Jet spectral behavior in blazar, not variable stars.
...
**Title Relevance Reason**:  
Gamma-ray simulations for PeVatron candidates, unrelated to variable stars.
...
**Title Relevance Reason**:  
Black hole mass calibrations and BLR relations, not variable stars.
...
**Title Relevance Reason**:  
Stellar occultation predictions for Haumea, unrelated to variable stars.
...
**Title Relevance Reason**:  
Prebiotic chemistry on exoplanets, unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy characterization, unrelated to variable stars.
...
**Title Relevance Reason**:  
Short GRB and neutron star merger rates, not variable stars.
...
**Title Relevance Reason**:  
Metal absorption and simulations in the CGM/IGM, unrelated to variable stars.
...
**Title Relevance Reason**:  
Reionization topology and dark matter, unrelated to variable stars.
...
**Title Relevance Reason**:  
Exoplanet atmosphere chemistry, unrelated to variable stars.
...
**Title Relevance Reason**:  
HI evolution of compact blue galaxies, unrelated to variable stars.
...
**Title Relevance Reason**:  
Black hole hot accretion flows, not variable stars.
...
**Title Relevance Reason**:  
Molecular cloud filament density function, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark matter/modified gravity theory, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark matter and primordial black holes, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark matter constraints from neutron stars, not variable stars.
...
**Title Relevance Reason**:  
Imperfect dark matter theory, unrelated to variable stars.
...
**Title Relevance Reason**:  
Black holes/black branes theory, unrelated to variable stars.
...
**Title Relevance Reason**:  
Wormhole shadow structure, unrelated to variable stars.
...
**Title Relevance Reason**:  
Thermal leptogenesis theory, unrelated to variable stars.
