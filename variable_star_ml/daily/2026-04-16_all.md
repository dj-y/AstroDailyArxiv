...
**Title Relevance Reason**:  
Asteroseismology of a red giant is a stellar variability/pulsation topic, though not clearly focused on variable-star ML or light-curve classification.
...
**Title Relevance Reason**:  
Massive binary system identified through radial velocity is relevant to binary-star variability, though not clearly eclipsing/light-curve focused.
...
**Title Relevance Reason**:  
Machine learning and early classification in time-domain astronomy are relevant methodologically, though the target is supernovae rather than variable stars.
...
**Title Relevance Reason**:  
Transient classification and novelty detection are ML/time-domain topics that could be methodologically relevant to variable-star classification.
...
**Title Relevance Reason**:  
Irregularly sampled time-series interpolation is methodologically relevant, but the application is binary evolution simulations rather than observed variable stars.
...
**Title Relevance Reason**:  
Replacing Gaussian processes with neural networks is strongly method-related to time-series inference, though applied to pulsar timing arrays rather than variable stars.
...
**Title Relevance Reason**:  
Photometric metallicities are relevant to one secondary keyword, but this is about a stellar stream rather than variable stars.
...
**Title Relevance Reason**:  
Deep learning applied to astronomical plate registration is ML in astronomy, but not about variable stars directly.
...
**Title Relevance Reason**:  
Contrastive learning and normalizing flows for inference are ML methods relevant in spirit, but this is gravitational-wave analysis rather than variable stars.
...
**Title Relevance Reason**:  
Pulsar population evolution concerns variable compact stars, but not the optical variable-star classes or light-curve ML focus.
...
**Title Relevance Reason**:  
A surviving star in an X-ray transient/supernova context is stellar, but this is not clearly a variable-star light-curve or classification study.
...
**Title Relevance Reason**:  
Supernova classification and microlensing are time-domain topics, but not variable-star science.
...
**Title Relevance Reason**:  
Automatic classification pipeline is methodologically relevant, but this is for detector glitches rather than stellar variability.
...
**Title Relevance Reason**:  
Galactic double white dwarfs are compact binaries, but this is gravitational-wave microlensing rather than variable-star light curves.
...
**Title Relevance Reason**:  
Metallicity appears in the title, but the topic is galaxy star formation and gas metallicity rather than variable stars.
...
**Title Relevance Reason**:  
Galactic archaeology survey may include stellar populations, but the title does not suggest variability or light-curve analysis.
...
**Title Relevance Reason**:  
Solar microvariability and spectral line changes involve stellar variability, but not the target variable-star classes.
...
**Title Relevance Reason**:  
Bayesian burst inference and model classification are generic time-series methods, but not applied to variable stars.
...
**Title Relevance Reason**:  
Ultra-compact X-ray binaries are variable binary systems, but not focused on optical variable-star classification or light curves.
...
**Title Relevance Reason**:  
Solar cycle predictability concerns stellar variability in a broad sense, but not variable-star light-curve studies.
...
**Title Relevance Reason**:  
Statistical denoising methods may be broadly useful, but this is not tied to variable stars or time-series light curves.
...
**Title Relevance Reason**:  
Spectral estimation methods are generic and could be useful for time series, but this paper is not about variable stars.
...
**Title Relevance Reason**:  
Type Ic supernova spectroscopy involves stellar transients, but not variable-star studies.
...
**Title Relevance Reason**:  
Genetic algorithm is an ML-related method, but applied to inflationary cosmology rather than variable stars.
...
**Title Relevance Reason**:  
Inference methodology paper, but focused on gravitational waves rather than stellar light curves.
...
**Title Relevance Reason**:  
White dwarf explosion study, involving stars but not variable-star light curves or classification.
...
**Title Relevance Reason**:  
Brightness trends are time-varying, but this is about satellites rather than stars.
...
**Title Relevance Reason**:  
Solar chromospheric dynamics concern stellar activity, but not variable-star light-curve analysis.
...
**Title Relevance Reason**:  
Afterglow discovery is time-domain astronomy, but not variable stars.
...
**Title Relevance Reason**:  
Quasi-periodic oscillations in black hole accretion are time-variable phenomena, but outside variable-star studies.
...
**Title Relevance Reason**:  
Lensed quasar discovery, not about variable stars or stellar light curves.
...
**Title Relevance Reason**:  
Periodic behavior in supermassive black holes, but not stellar variability.
...
**Title Relevance Reason**:  
Asteroid impact simulation, unrelated to stellar variability or variable stars.
...
**Title Relevance Reason**:  
Interstellar gas structure study, unrelated to variable stars.
...
**Title Relevance Reason**:  
Black hole tail gas dynamics, not connected to stellar variability.
...
**Title Relevance Reason**:  
Circumgalactic gas around a quasar, unrelated to variable stars.
...
**Title Relevance Reason**:  
Circumgalactic medium absorption study, not relevant to variable stars.
...
**Title Relevance Reason**:  
Dual AGN in galaxies, not about variable stars.
...
**Title Relevance Reason**:  
High-redshift quasar candidate catalog, unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy gas inflows and AGN activity, unrelated to variable stars.
...
**Title Relevance Reason**:  
Planetary moon resonance dynamics, unrelated to stellar variability.
...
**Title Relevance Reason**:  
Galaxy starburst survey, not about variable stars.
...
**Title Relevance Reason**:  
Galaxy SED modeling, unrelated to variable stars.
...
**Title Relevance Reason**:  
Galactic structure with Gaia, not focused on stellar variability.
...
**Title Relevance Reason**:  
Dust around small Solar System bodies, unrelated to variable stars.
...
**Title Relevance Reason**:  
Cosmic reionization study, unrelated to variable stars.
...
**Title Relevance Reason**:  
Earth co-orbitals of lunar origin, not relevant to variable stars.
...
**Title Relevance Reason**:  
Galactic center molecular line observations, unrelated to stellar variability.
...
**Title Relevance Reason**:  
High-redshift galaxy morphology study, unrelated to variable stars.
...
**Title Relevance Reason**:  
Reionization model for CMB analyses, not about variable stars.
...
**Title Relevance Reason**:  
Milky Way halo substructure, unrelated to variable stars.
...
**Title Relevance Reason**:  
Telescope site quality analysis, not about stellar variability.
...
**Title Relevance Reason**:  
Galaxy rotation curve corpus, unrelated to variable stars.
...
**Title Relevance Reason**:  
Early dark energy cosmology, unrelated to variable stars.
...
**Title Relevance Reason**:  
Accreting neutron star magnetic mountains, not about variable stars.
...
**Title Relevance Reason**:  
X-ray mission background simulation, unrelated to variable stars.
...
**Title Relevance Reason**:  
Solar jet extraction tool, unrelated to variable stars.
...
**Title Relevance Reason**:  
Neutrino flavor conversion, unrelated to variable stars.
...
**Title Relevance Reason**:  
Star clusters in a galaxy, unrelated to stellar variability.
...
**Title Relevance Reason**:  
Planetary radio signals and coronal activity, not about variable stars.
...
**Title Relevance Reason**:  
Protostellar outflow and maser study, unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy H I evolution, not relevant to variable stars.
...
**Title Relevance Reason**:  
Gamma-ray burst spatial density and large-scale structure, unrelated to variable stars.
...
**Title Relevance Reason**:  
Reionization optical depth cosmology, unrelated to variable stars.
...
**Title Relevance Reason**:  
Black hole accretion flow cooling, not about variable stars.
...
**Title Relevance Reason**:  
Protostellar winds and jets survey, unrelated to variable-star analysis.
...
**Title Relevance Reason**:  
Supernova host galaxy outflows, unrelated to variable stars.
...
**Title Relevance Reason**:  
High-redshift galaxy and cosmology study, unrelated to variable stars.
...
**Title Relevance Reason**:  
Neutrino and gamma-ray burst correlation, not about variable stars.
...
**Title Relevance Reason**:  
All-sky monitor instrumentation paper, not specifically about variable stars.
...
**Title Relevance Reason**:  
Solar corona morphology, unrelated to variable stars.
...
**Title Relevance Reason**:  
Solar energetic particles, not about variable stars.
...
**Title Relevance Reason**:  
Solar prominence line analysis, unrelated to variable stars.
...
**Title Relevance Reason**:  
Solar prominence plasma diagnostics, not relevant to variable stars.
...
**Title Relevance Reason**:  
Prominence plasma parameter mapping in the Sun, unrelated to variable stars.
...
**Title Relevance Reason**:  
Solar eruptive prominence analysis, not about variable stars.
...
**Title Relevance Reason**:  
Microwave data analysis package, too generic and not tied to variable stars.
...
**Title Relevance Reason**:  
Compact binary coalescence search in GW data, not about variable stars.
...
**Title Relevance Reason**:  
Protoplanetary disk volatiles, unrelated to variable stars.
...
**Title Relevance Reason**:  
Molecular gas structure in a galaxy, not relevant to stellar variability.
...
**Title Relevance Reason**:  
Strong-lensing H0 measurement, unrelated to variable stars.
...
**Title Relevance Reason**:  
Observation scheduling tool, not about variable stars.
...
**Title Relevance Reason**:  
Disk potentials in dynamics, unrelated to variable stars.
...
**Title Relevance Reason**:  
Axion searches with interferometry, not about variable stars.
...
**Title Relevance Reason**:  
Nonlocal black holes via lensing, unrelated to variable stars.
...
**Title Relevance Reason**:  
GW detector sky localization study, not about variable stars.
...
**Title Relevance Reason**:  
Axion inflation theory, unrelated to variable stars.
...
**Title Relevance Reason**:  
Technosphere detectability and civilization dynamics, unrelated to variable stars.
...
**Title Relevance Reason**:  
Interstellar communication experiment, unrelated to variable stars.
...
**Title Relevance Reason**:  
Gravitational formalism paper, not relevant to variable stars.
...
**Title Relevance Reason**:  
Chern-Simons gravity theory, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dual AGN candidate search, not about variable stars.
...
**Title Relevance Reason**:  
Axion inflation and gravitational waves, unrelated to variable stars.
...
**Title Relevance Reason**:  
Primordial black holes and cosmological non-Gaussianity, not relevant to variable stars.
...
**Title Relevance Reason**:  
Circumgalactic turbulence, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark matter heating in proto-neutron stars, not about variable-star observations or modeling.
...
**Title Relevance Reason**:  
Hubble constant anisotropy, unrelated to variable stars.
...
**Title Relevance Reason**:  
X-ray stacking of galaxy clusters, not relevant to variable stars.
...
**Title Relevance Reason**:  
Infrared spectrograph archive, unrelated to variable stars.
...
**Title Relevance Reason**:  
Extragalactic background light decomposition, unrelated to variable stars.
...
**Title Relevance Reason**:  
Blazar identification, not about variable stars.
...
**Title Relevance Reason**:  
Quasar proximity effect, unrelated to variable stars.
...
**Title Relevance Reason**:  
Protoplanetary disk MHD simulations, not relevant to variable stars.
...
**Title Relevance Reason**:  
Disk turbulence and pebble fluxes in protoplanetary disks, unrelated to variable stars.
...
**Title Relevance Reason**:  
Water isotopic ratio in an interstellar object, unrelated to variable stars.
...
**Title Relevance Reason**:  
Covariant cosmology paper, not about variable stars.
...
**Title Relevance Reason**:  
Cosmological perturbation theory, unrelated to variable stars.
...
**Title Relevance Reason**:  
Pre-supernova neutrino support tooling, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dual AGN in a merger, not relevant to variable stars.
...
**Title Relevance Reason**:  
Massive black hole binaries in dwarf galaxies, not about variable stars.
...
**Title Relevance Reason**:  
Cosmic ray composition and dark matter via muon tomography, unrelated to variable stars.
...
**Title Relevance Reason**:  
Cosmological correlator renormalization, not relevant to variable stars.
...
**Title Relevance Reason**:  
Direct collapse black hole candidates, unrelated to variable stars.
...
**Title Relevance Reason**:  
Cosmological correlator bootstrap theory, not about variable stars.
...
**Title Relevance Reason**:  
Dark Higgs inflation and dark photon production, unrelated to variable stars.
...
**Title Relevance Reason**:  
Celestial dynamics approximations in three-body systems, not about variable stars.
...
**Title Relevance Reason**:  
Black holes, cosmic strings, and axion dark matter, unrelated to variable stars.
...
**Title Relevance Reason**:  
Finite element formulation for Newtonian noise analysis, not relevant to variable stars.
