...
**Title Relevance Reason**:  
Strong match on deep learning and phase-folded light curves, but the target is exoplanet candidate identification rather than variable stars.
...
**Title Relevance Reason**:  
Stellar-parameter inference is relevant to physical inference around stars, but the title does not indicate variability or light-curve analysis.
...
**Title Relevance Reason**:  
Stellar metallicity and binaries are somewhat adjacent, but this is not a variability or light-curve study.
...
**Title Relevance Reason**:  
RGB common-envelope interactions involve stellar/binary evolution, but not observational variability or light-curve modeling.
...
**Title Relevance Reason**:  
Binary-star evolution is adjacent, but the focus is X-ray binaries and neutron stars rather than variable-star light-curve analysis.
...
**Title Relevance Reason**:  
Uses eclipse photometry and stellar uncertainties, but the focus is rocky exoplanets rather than variable stars.
...
**Title Relevance Reason**:  
Observational study of a stellar class, but focused on kinematics of Wolf-Rayet stars rather than variability.
...
**Title Relevance Reason**:  
About stellar rotation measurements for M dwarfs, not light-curve variability or variable-star inference.
...
**Title Relevance Reason**:  
Includes metallicity, but in the context of supernova demographics rather than variable-star inference.
...
**Title Relevance Reason**:  
Stellar magnetic-field observations are relevant to stellar physics, but the focus is CMEs rather than variable-star behavior.
...
**Title Relevance Reason**:  
Binary inspiral in protostellar systems is loosely adjacent to stellar binaries, but not variable-star light-curve work.
...
**Title Relevance Reason**:  
Stellar-wind modeling is stellar physics, but not focused on variability, light curves, or time-series inference.
...
**Title Relevance Reason**:  
Contains variability language, but it concerns black hole accretion systems rather than stellar variable classes.
...
**Title Relevance Reason**:  
Time-domain transient detectability in LSST is loosely adjacent, but kilonova lensing is not a variable-star study.
...
**Title Relevance Reason**:  
Exoplanet system discovery may involve photometric curves, but the title is not about stellar variability.
...
**Title Relevance Reason**:  
Uses convolutional neural networks for astrophysical inference, but on galaxy clusters rather than variable stars.
...
**Title Relevance Reason**:  
Open cluster catalog completeness is only loosely related through stellar populations, not variable stars.
...
**Title Relevance Reason**:  
Machine learning appears, but for molecular spectroscopy rather than variable stars.
...
**Title Relevance Reason**:  
Neural networks are used, but for Galactic foreground modeling rather than stellar variability.
...
**Title Relevance Reason**:  
Time-dependent solar activity prediction is loosely adjacent to variability, but not about variable stars.
...
**Title Relevance Reason**:  
Metallicity calibration is relevant only at the keyword level, but this is a galaxy emission-line paper.
...
**Title Relevance Reason**:  
Hierarchical Bayesian modeling and glitches are methodologically adjacent, but this is GW detector noise analysis.
...
**Title Relevance Reason**:  
Stellar streams measurement concerns stars observationally, but not stellar variability.
...
**Title Relevance Reason**:  
Solar interior dynamics are stellar physics, but the title does not indicate variable-star analysis.
...
**Title Relevance Reason**:  
Automated forecasting and magnetic-structure inference appear, but for coronal mass ejections rather than variable stars.
...
**Title Relevance Reason**:  
Neural posterior estimation appears, but for gravitational-wave detector design rather than stellar variability.
...
**Title Relevance Reason**:  
Pulsar polarization is a compact-object timing topic, not stellar variability in the variable-star sense.
...
**Title Relevance Reason**:  
Solar atmosphere observations are only loosely connected to time-variable astrophysics, not variable stars.
...
**Title Relevance Reason**:  
Solar spectral-line sensitivity to granulation is not a variable-star light-curve study.
...
**Title Relevance Reason**:  
Black hole accretion and imaging topic, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark energy N-body simulation methods, unrelated to stellar variability.
...
**Title Relevance Reason**:  
Galaxy/AGN interstellar medium study, not about variable stars.
...
**Title Relevance Reason**:  
Large-scale structure and 21cm cosmology topic, unrelated to variable stars.
...
**Title Relevance Reason**:  
Core-collapse supernova signal characterization, not variable-star analysis.
...
**Title Relevance Reason**:  
Star-forming region disk fractions, unrelated to variable stars.
...
**Title Relevance Reason**:  
Instrumentation/software for IFUs, not a variable-star science paper.
...
**Title Relevance Reason**:  
Pulsar wind nebula cosmic-ray contribution, unrelated to variable stars.
...
**Title Relevance Reason**:  
Planetary nebula kinematics topic, not variable stars.
...
**Title Relevance Reason**:  
Galaxy gas and star formation study, unrelated to variable stars.
...
**Title Relevance Reason**:  
Molecular cloud distances, not a stellar variability paper.
...
**Title Relevance Reason**:  
Sgr A* polarization imaging, unrelated to variable stars.
...
**Title Relevance Reason**:  
Molecular cloud collision study, unrelated to variable stars.
...
**Title Relevance Reason**:  
General inference/systematics methods paper, not tied to variable stars.
...
**Title Relevance Reason**:  
Plasma wave scattering topic, unrelated to variable stars.
...
**Title Relevance Reason**:  
Asteroid shape modeling from starlight diffraction, not variable stars.
...
**Title Relevance Reason**:  
Hot Jupiter atmospheric chemistry, unrelated to variable stars.
...
**Title Relevance Reason**:  
Exoplanet structure simulations, unrelated to variable stars.
...
**Title Relevance Reason**:  
Interstellar ice chemistry topic, not variable stars.
...
**Title Relevance Reason**:  
Solar-system relativity timing topic, unrelated to variable stars.
...
**Title Relevance Reason**:  
Planetary nebulae and HII region kinematics, not variable stars.
...
**Title Relevance Reason**:  
Tidal disruption event observations, unrelated to variable stars.
...
**Title Relevance Reason**:  
Solar magnetic-flux transport topic, not variable stars.
...
**Title Relevance Reason**:  
AGN X-ray spectroscopy, unrelated to variable stars.
...
**Title Relevance Reason**:  
Primordial black hole radio constraints, not variable stars.
...
**Title Relevance Reason**:  
Cosmological spacetime modeling, unrelated to variable stars.
...
**Title Relevance Reason**:  
Solar-wind magnetic switchbacks review, not variable stars.
...
**Title Relevance Reason**:  
Globular cluster morphology/X-ray relation, not variable stars.
...
**Title Relevance Reason**:  
High-redshift galaxy population study, unrelated to variable stars.
...
**Title Relevance Reason**:  
Pulsar beaming statistics, unrelated to variable stars.
...
**Title Relevance Reason**:  
Gravitational waves from pulsars, not a variable-star paper.
...
**Title Relevance Reason**:  
Magnetic connectivity toolkit, unrelated to variable stars.
...
**Title Relevance Reason**:  
AGN iron-line spectroscopy, not variable stars.
...
**Title Relevance Reason**:  
Planetary surface degradation on Ceres, unrelated to variable stars.
...
**Title Relevance Reason**:  
Titan prebiotic chemistry topic, unrelated to variable stars.
...
**Title Relevance Reason**:  
Kuiper belt object shape formation, not variable stars.
...
**Title Relevance Reason**:  
Quasar radiation and circumgalactic gas, unrelated to variable stars.
...
**Title Relevance Reason**:  
Exoplanet transit-timing variations, not variable stars.
...
**Title Relevance Reason**:  
Planet migration theory, unrelated to variable stars.
...
**Title Relevance Reason**:  
Particle physics model paper, unrelated to astrophysical variable stars.
...
**Title Relevance Reason**:  
LaTeX citation tool, not an astrophysics paper relevant to the topic.
...
**Title Relevance Reason**:  
Binary black hole merger waveforms, unrelated to variable stars.
...
**Title Relevance Reason**:  
Black hole theory paper, not variable stars.
...
**Title Relevance Reason**:  
Gravitational-wave detector concept, unrelated to variable stars.
...
**Title Relevance Reason**:  
Gravitational-wave parameter estimation, not variable stars.
...
**Title Relevance Reason**:  
Tests of black hole spacetimes with GW data, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark matter production in the early universe, unrelated to variable stars.
...
**Title Relevance Reason**:  
Modified gravity constraints, unrelated to variable stars.
...
**Title Relevance Reason**:  
String-theory cosmology review, unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy environment evolution with Euclid, not variable stars.
...
**Title Relevance Reason**:  
Giant-planet atmospheric jets, unrelated to variable stars.
...
**Title Relevance Reason**:  
Cosmological clustering test, not variable stars.
...
**Title Relevance Reason**:  
CMB and cosmic filaments topic, unrelated to variable stars.
...
**Title Relevance Reason**:  
Neutron-star matter microphysics, unrelated to variable stars.
...
**Title Relevance Reason**:  
Planet formation in binaries, unrelated to variable stars.
...
**Title Relevance Reason**:  
Neutron-star equation-of-state topic, not variable stars.
...
**Title Relevance Reason**:  
Galaxy kinematic scaling relations, unrelated to variable stars.
...
**Title Relevance Reason**:  
Foreground synchrotron parameter forecasting, not variable stars.
...
**Title Relevance Reason**:  
Cosmic-ray air-shower physics, unrelated to variable stars.
...
**Title Relevance Reason**:  
Weak-lensing shear analysis, unrelated to variable stars.
...
**Title Relevance Reason**:  
Kilonova composition constraints, not variable stars.
...
**Title Relevance Reason**:  
Radio interference mitigation methodology, unrelated to variable stars.
...
**Title Relevance Reason**:  
Cosmic void theory in modified gravity, not variable stars.
...
**Title Relevance Reason**:  
Dwarf-galaxy evolution topic, unrelated to variable stars.
...
**Title Relevance Reason**:  
Bayesian cosmic void finding, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark siren cosmology framework, unrelated to variable stars.
...
**Title Relevance Reason**:  
Streamer plasma dynamics, not variable stars.
...
**Title Relevance Reason**:  
Exoplanet biosignature retrieval, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark matter-baryon interactions in a galaxy simulation, not variable stars.
...
**Title Relevance Reason**:  
Coupled dark energy/dark matter cosmology, unrelated to variable stars.
...
**Title Relevance Reason**:  
GRB afterglow discovery prospects, not variable stars.
...
**Title Relevance Reason**:  
Solar-wind plasma-wave study, unrelated to variable stars.
...
**Title Relevance Reason**:  
General gravitational-wave physics, unrelated to variable stars.
...
**Title Relevance Reason**:  
Inflation model-building paper, unrelated to variable stars.
...
**Title Relevance Reason**:  
Condensed-matter/device physics, not an astrophysical variable-star paper.
...
**Title Relevance Reason**:  
Gravity-theory parametrization, unrelated to variable stars.
...
**Title Relevance Reason**:  
Quantum fields in de Sitter topic, unrelated to variable stars.
...
**Title Relevance Reason**:  
Neutron-star GW inference, not variable stars.
...
**Title Relevance Reason**:  
Black hole ringdown tests of relativity, unrelated to variable stars.
