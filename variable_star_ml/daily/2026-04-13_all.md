...
TESS eclipsing binaries are directly within variable-star territory, though the goal is finding circumbinary planets rather than stellar variability inference itself.
...
**Title Relevance Reason**:  
T Coronae Borealis is a recurrent nova and variable stellar system, though the focus is neutrino predictions rather than light-curve modeling or ML.
...
**Title Relevance Reason**:  
Neural networks for stellar parameter inference are methodologically and stellar-population relevant, but the title does not mention variability or light curves.
...
**Title Relevance Reason**:  
Transit light-curve analysis with deep learning is strongly method-adjacent, though focused on orbiting objects around stars rather than intrinsic/eclipsing variable-star inference.
...
**Title Relevance Reason**:  
CNN-based catalog and classification of solar flares involves time-series/event detection, but for solar activity rather than variable stars.
...
**Title Relevance Reason**:  
Evolved stars and chemical abundances are relevant stellar populations, but the title focuses on spectroscopy rather than variability or light curves.
...
**Title Relevance Reason**:  
Time-delay estimation for a lensed supernova is time-domain inference, but not variable-star classification or modeling.
...
**Title Relevance Reason**:  
Machine learning is a key secondary method, but this paper is about planetary science rather than variable stars.
...
**Title Relevance Reason**:  
Outburst evolution of Aql X-1 is a stellar time-domain source study, but it is an X-ray binary/transient rather than the variable-star classes emphasized here.
...
**Title Relevance Reason**:  
Uses variability and machine learning, but for thermal dust echoes and historical supernovae rather than variable stars.
...
**Title Relevance Reason**:  
Flare energetics from solar irradiance observations involve temporal variability, but the topic is solar flares rather than variable stars.
...
**Title Relevance Reason**:  
Microlensing simulations are time-domain and stellar-observationally adjacent, but not focused on variable-star classification or light-curve inference.
...
**Title Relevance Reason**:  
Deep-learning multiclass classification is methodologically relevant, but the application is gravitational-wave glitches rather than variable stars.
...
**Title Relevance Reason**:  
Long-term optical monitoring is time-domain work, but the Einstein Cross is a lensed quasar system, not variable stars.
...
**Title Relevance Reason**:  
Transformer-based event reconstruction uses machine learning, but for gamma-ray detectors rather than variable-star classification.
...
**Title Relevance Reason**:  
Machine-learning inference tool is method-relevant, but for gravitational waves, not variable stars.
...
**Title Relevance Reason**:  
Photometry-based inference is methodologically adjacent, but for directly imaged exoplanet systems rather than variable stars.
...
**Title Relevance Reason**:  
Time evolution of a supernova spectrum is time-domain astrophysics, but not variable-star analysis.
...
**Title Relevance Reason**:  
Transit detection and characterization use light curves and time series, but for exoplanets rather than variable stars.
...
**Title Relevance Reason**:  
Bias correction and morphology quantification are survey-analysis methods, but for galaxies rather than variable stars.
...
**Title Relevance Reason**:  
High-time-resolution pulsar pulse searches involve astrophysical time-series, but pulsars are outside the main variable-star classes emphasized here.
...
**Title Relevance Reason**:  
Automated detection with survey data is methodologically adjacent, but the target is planetary nebulae, not variable stars.
...
**Title Relevance Reason**:  
Transit timing variations involve time-series modeling, but the subject is exoplanet masses, not variable stars.
...
**Title Relevance Reason**:  
Pulsar companion composition via tides concerns compact-object binaries, not the variable-star classes emphasized.
...
**Title Relevance Reason**:  
Flux eruptions and polarization around black holes involve variability, but not variable stars.
...
**Title Relevance Reason**:  
Point-source magnification on accretion disks touches photometric variation, but not variable-star science.
...
**Title Relevance Reason**:  
Protostellar envelope/ice inventory around EC 53 may involve a variable young object, but the title is not about variability analysis.
...
**Title Relevance Reason**:  
Circumstellar nebula modeling around stars is stellar-related, but not about variability, classification, or light curves.
...
**Title Relevance Reason**:  
Radio monitoring of a repeating FRB involves temporal behavior, but not stellar variability of the target types.
...
**Title Relevance Reason**:  
Bayesian inference and dynamical modeling are relevant methods, but applied to multiplanet systems rather than variable stars.
...
**Title Relevance Reason**:  
Inference and differentiable programming are relevant methods, but the target is gamma-ray sky, not variable stars.
...
**Title Relevance Reason**:  
Data fitting methodology is broadly relevant, but the application is asteroid orbit determination, not variable stars.
...
**Title Relevance Reason**:  
Dark matter halo/core formation study; unrelated to variable stars or stellar light curves.
...
**Title Relevance Reason**:  
Primordial neutron stars are unrelated to variable-star observations, classification, or modeling.
...
**Title Relevance Reason**:  
Circumgalactic medium temperature asymmetry is unrelated to stellar variability.
...
**Title Relevance Reason**:  
Optical sensor/wavefront sensing instrumentation paper, not about variable stars.
...
**Title Relevance Reason**:  
Galaxy morphology in JWST data is unrelated to variable stars.
...
**Title Relevance Reason**:  
AGN-driven outflow in a high-redshift galaxy; not related to stellar variability.
...
**Title Relevance Reason**:  
Asteroid YORP effect paper; unrelated to variable stars.
...
**Title Relevance Reason**:  
Gamma-ray counterparts of neutron star mergers are outside the variable-star topic.
...
**Title Relevance Reason**:  
Radio astronomy historical colloquium; not a variable-star study.
...
**Title Relevance Reason**:  
IceCube detector instrumentation paper, unrelated to variable stars.
...
**Title Relevance Reason**:  
Europa-like planetary conditions paper; unrelated to stellar variability.
...
**Title Relevance Reason**:  
Asteroid mission overview; unrelated to variable stars.
...
**Title Relevance Reason**:  
Solar CME evolution paper, not about stellar variability of the target types.
...
**Title Relevance Reason**:  
Correlation function code for clustering measurements is unrelated to variable stars.
...
**Title Relevance Reason**:  
Large-scale structure/power spectrum analysis, not relevant to stellar variability.
...
**Title Relevance Reason**:  
Dense gas heating in the Galactic Center is unrelated to variable stars.
...
**Title Relevance Reason**:  
General polarimetry review, not focused on variable stars or light-curve modeling.
...
**Title Relevance Reason**:  
Habitable zone spectral signatures are unrelated to variable stars.
...
**Title Relevance Reason**:  
Collision modeling with SPH is unrelated to variable stars.
...
**Title Relevance Reason**:  
Planetary system formation review; not relevant to variable stars.
...
**Title Relevance Reason**:  
Exoplanet spectrograph instrumentation paper, not about variable stars.
...
**Title Relevance Reason**:  
Giant planet formation paper; unrelated to stellar variability.
...
**Title Relevance Reason**:  
Low surface brightness galaxy properties are unrelated to variable stars.
...
**Title Relevance Reason**:  
Optical identification of survey sources in the local volume is not about variable stars.
...
**Title Relevance Reason**:  
Dust processing in protoplanetary disks is unrelated to variable stars.
...
**Title Relevance Reason**:  
Extragalactic background light measurement is unrelated to variable stars.
...
**Title Relevance Reason**:  
Axion dark energy constraints are unrelated to stellar variability.
...
**Title Relevance Reason**:  
Cosmic web topology and neutrino mass study; unrelated to variable stars.
...
**Title Relevance Reason**:  
High-redshift AGN/galaxy paper, unrelated to variable stars.
...
**Title Relevance Reason**:  
X-ray lens production/instrumentation paper; not about variable stars.
...
**Title Relevance Reason**:  
Terrestrial planet formation modeling is unrelated to stellar variability.
...
**Title Relevance Reason**:  
Astrochemistry of solid-state hydrogenation network; unrelated to variable stars.
...
**Title Relevance Reason**:  
Title is too generic, with no indication of variable stars or relevant methods.
...
**Title Relevance Reason**:  
Disk chemistry paper unrelated to stellar variability.
...
**Title Relevance Reason**:  
High-redshift quiescent galaxies study; unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy molecular gas star-formation relation; unrelated to variable stars.
...
**Title Relevance Reason**:  
Exoplanet atmosphere characterization is unrelated to variable stars.
...
**Title Relevance Reason**:  
Extragalactic background light paper; unrelated to stellar variability.
...
**Title Relevance Reason**:  
Little Red Dot nebular continua paper; unrelated to variable stars.
...
**Title Relevance Reason**:  
Lyman-alpha forest EFT compression is unrelated to variable stars.
...
**Title Relevance Reason**:  
Satellite constellation effects on observations is not about variable stars.
...
**Title Relevance Reason**:  
Quasar absorption forest explanation, unrelated to variable stars.
...
**Title Relevance Reason**:  
Spectrograph design/instrumentation paper, not about variable stars.
...
**Title Relevance Reason**:  
Galaxy spectral identification paper; unrelated to variable stars.
...
**Title Relevance Reason**:  
Lunar regolith/supernova debris modeling is unrelated to variable stars.
...
**Title Relevance Reason**:  
High-contrast imaging of protoplanets is not relevant to variable stars.
...
**Title Relevance Reason**:  
Milky Way satellite galaxy census is unrelated to variable stars.
...
**Title Relevance Reason**:  
Fluid dynamics paper unrelated to astrophysical variable stars.
...
**Title Relevance Reason**:  
Ocean/bio-optical observations are outside astrophysics and irrelevant here.
...
**Title Relevance Reason**:  
Compact-object tidal properties paper; unrelated to variable stars.
...
**Title Relevance Reason**:  
Modified gravity theory paper; unrelated to variable stars.
...
**Title Relevance Reason**:  
Tidal response of compact objects is unrelated to stellar variability.
...
**Title Relevance Reason**:  
Quantum cosmology paper unrelated to variable stars.
...
**Title Relevance Reason**:  
LISA kinematic dipole analysis is unrelated to variable stars.
...
**Title Relevance Reason**:  
Scalar-tensor gravity theory paper; unrelated to variable stars.
...
**Title Relevance Reason**:  
Plasma evolution and magnetogenesis are unrelated to variable stars.
...
**Title Relevance Reason**:  
Solar symmetron direct detection paper; not about variable stars.
...
**Title Relevance Reason**:  
CMB/dark radiation paper, unrelated to variable stars.
...
**Title Relevance Reason**:  
Four-body configurations in celestial mechanics are unrelated to variable stars.
...
**Title Relevance Reason**:  
High-redshift accreting source paper; unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy formation and disk survival are unrelated to variable stars.
...
**Title Relevance Reason**:  
Matter power spectrum simulations are unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark matter/neutrino wake detection in large-scale structure is unrelated to variable stars.
...
**Title Relevance Reason**:  
Sub-Neptune interior/chemistry paper; unrelated to variable stars.
...
**Title Relevance Reason**:  
Satellite lifetime validation is unrelated to variable stars.
...
**Title Relevance Reason**:  
Comet/interstellar object volatile inventory is unrelated to variable stars.
...
**Title Relevance Reason**:  
High-redshift AGN population in galaxies; unrelated to variable stars.
...
**Title Relevance Reason**:  
Wavefront correction instrumentation paper, not about variable stars.
...
**Title Relevance Reason**:  
Galaxy baryon budget in the early universe is unrelated to variable stars.
...
**Title Relevance Reason**:  
C++ timing system software paper; unrelated to astrophysical variable stars.
...
**Title Relevance Reason**:  
Giant radio source formation in galaxy halos is unrelated to variable stars.
...
**Title Relevance Reason**:  
Solar corona/heliosphere magnetic connectivity is unrelated to variable stars.
...
**Title Relevance Reason**:  
Planet system architecture around M dwarfs; unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy power spectrum and bispectrum modeling are unrelated to variable stars.
...
**Title Relevance Reason**:  
Strong-lens redshift catalog paper; unrelated to variable stars.
...
**Title Relevance Reason**:  
Cosmological phase transition simulations are unrelated to variable stars.
...
**Title Relevance Reason**:  
Black-hole binary spin precession paper; unrelated to variable stars.
...
**Title Relevance Reason**:  
Inflation theory paper; unrelated to variable stars.
...
**Title Relevance Reason**:  
Solar wind turbulence study, not related to variable stars.
