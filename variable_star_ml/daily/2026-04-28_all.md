...
**Title Relevance Reason**:  
Symbiotic stars can be variable systems, but title centers on candidate identification, not variability analysis.
...
**Title Relevance Reason**:  
Magnified stellar events are time-domain stellar phenomena, though not clearly variable-star classification/modeling.
...
**Title Relevance Reason**:  
Binary stars are adjacent, but this is astrometric mass measurement, not variability analysis.
...
**Title Relevance Reason**:  
Massive binaries and X-ray binaries are adjacent stellar systems, but not focused on variability or light curves.
...
**Title Relevance Reason**:  
Machine learning classification is relevant in method only; meteors are off-topic.
...
**Title Relevance Reason**:  
Sparse photometry and taxonomy use relevant methods, but on trans-Neptunian objects.
...
**Title Relevance Reason**:  
Machine learning classification is relevant methodologically, but applied to galaxies.
...
**Title Relevance Reason**:  
Pulsed radio emission involves periodic behavior, but it is a neutron-star/pulsar topic, not variable stars.
...
**Title Relevance Reason**:  
Binary stars are adjacent to eclipsing-binary topics, but this is evolutionary theory rather than variability analysis.
...
**Title Relevance Reason**:  
Has 'light curve' in the title, but for an exocomet rather than a variable star.
...
**Title Relevance Reason**:  
M-dwarf catalog may include stellar properties, but not variability-focused.
...
**Title Relevance Reason**:  
Brown dwarfs are stellar/substellar objects, but no variability focus.
...
**Title Relevance Reason**:  
Operator learning of spectra is methodologically adjacent, but not variable-star focused.
...
**Title Relevance Reason**:  
AI for astronomical reasoning is method-related, but not specifically light curves or variable stars.
...
**Title Relevance Reason**:  
Spectral time series appears relevant to time-domain astronomy, but on supernovae, not variable stars.
...
**Title Relevance Reason**:  
Supernova spectral time series, time-domain but not variable-star focused.
...
**Title Relevance Reason**:  
Real-time scoring of kilonovae uses ML-like methods, but not variable stars.
...
**Title Relevance Reason**:  
Neural-network surrogate modeling, but for galaxy formation, not variable stars.
...
**Title Relevance Reason**:  
Physics-informed neural methods are relevant in approach only; topic is instrumentation.
...
**Title Relevance Reason**:  
Optical spectra of transients are time-domain, but not variable stars.
...
**Title Relevance Reason**:  
Orbit evolution in an exoplanet system, not stellar variability.
...
**Title Relevance Reason**:  
Artificial neural networks are relevant methods, but topic is cosmology.
...
**Title Relevance Reason**:  
White dwarfs with companions are stellar, but not variability-focused.
...
**Title Relevance Reason**:  
Milky Way mapping with red clumps is stellar, but not about variability.
...
**Title Relevance Reason**:  
Stellar abundances are relevant to stars broadly, but no variability focus.
...
**Title Relevance Reason**:  
Diffusion models in astronomy are methodologically relevant, but for weak lensing maps.
...
**Title Relevance Reason**:  
Type Ia supernova paper is time-domain astronomy, but not variable stars.
...
**Title Relevance Reason**:  
Stellar evolution in AGN disks, not variable-star light-curve work.
...
**Title Relevance Reason**:  
Pulsar polarization study, unrelated to variable stars.
...
**Title Relevance Reason**:  
Open cluster system analysis, only tangentially stellar.
...
**Title Relevance Reason**:  
OB cluster photometric structure, but not light-curve variability.
...
**Title Relevance Reason**:  
Line modulation in X-ray binary, variability-like wording but not variable-star light curves.
...
**Title Relevance Reason**:  
Exotic neutron-star envelope objects, not variable-star analysis.
...
**Title Relevance Reason**:  
Flux signatures in blast waves are time-domain, but not variable stars.
...
**Title Relevance Reason**:  
Pulsar-related, not variable stars.
...
**Title Relevance Reason**:  
Brown dwarf and exoplanet system architecture, not variable stars.
...
**Title Relevance Reason**:  
Star-forming region astrometry, only tangentially stellar.
...
**Title Relevance Reason**:  
Open cluster member recovery, only broadly stellar.
...
**Title Relevance Reason**:  
Circumbinary planet formation, not variable stars.
...
**Title Relevance Reason**:  
Uses SNe Ia and variational inference, but not variable stars.
...
**Title Relevance Reason**:  
Type Ia supernova calibration, time-domain but not variable stars.
...
**Title Relevance Reason**:  
Kilonovae and GRBs are transients, but not variable stars.
...
**Title Relevance Reason**:  
AI in astronomy is broadly methodological, but not specific to variable stars.
...
**Title Relevance Reason**:  
Inner disk structure around a star, but not stellar variability.
...
**Title Relevance Reason**:  
Discrete stellar kinematics in nuclear cluster, but not variability-focused.
...
**Title Relevance Reason**:  
Protoplanetary disk dust dynamics, not stellar variability.
...
**Title Relevance Reason**:  
Galaxy simulation methodology, not stellar variability.
...
**Title Relevance Reason**:  
Dwarf galaxies in clusters, unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy environment study, not stellar variability.
...
**Title Relevance Reason**:  
AGN outflows, unrelated to variable stars.
...
**Title Relevance Reason**:  
Supermassive stars and black holes in clusters, not variable stars.
...
**Title Relevance Reason**:  
Main-belt comet observations, not stellar variability.
...
**Title Relevance Reason**:  
Comet volatile characterization, unrelated to variable stars.
...
**Title Relevance Reason**:  
Oort Cloud and primordial black holes, not variable stars.
...
**Title Relevance Reason**:  
Dark energy cosmology, unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy cluster X-ray gas component, not variable stars.
...
**Title Relevance Reason**:  
Planetary nebulae review, unrelated to variable-star studies.
...
**Title Relevance Reason**:  
Hydrodynamics method paper, not stellar variability.
...
**Title Relevance Reason**:  
Solar prominence eruption, not variable stars.
...
**Title Relevance Reason**:  
Ultra-high-energy cosmic rays, unrelated to variable stars.
...
**Title Relevance Reason**:  
Quasar SEDs, unrelated to variable stars.
...
**Title Relevance Reason**:  
Exoplanet instrumentation, not variable stars.
...
**Title Relevance Reason**:  
Detector irradiation campaign, not variable stars.
...
**Title Relevance Reason**:  
Early-universe preheating theory, unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy and halo functions, not stellar variability.
...
**Title Relevance Reason**:  
Observation simulator for submillimeter astronomy, not variable stars.
...
**Title Relevance Reason**:  
Solar filament eruption, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark matter in M31 rotation curve, not variable stars.
...
**Title Relevance Reason**:  
LIGO noise analysis tool, unrelated to variable stars.
...
**Title Relevance Reason**:  
Cluster dynamics and modified gravity, not variable stars.
...
**Title Relevance Reason**:  
Binary planets and exomoons, not stellar variability.
...
**Title Relevance Reason**:  
Cosmological curvature discussion, unrelated to variable stars.
...
**Title Relevance Reason**:  
Cluster mass profiles and gravity, unrelated to variable stars.
...
**Title Relevance Reason**:  
Interstellar gas structure in the Milky Way, not variable stars.
...
**Title Relevance Reason**:  
High-energy source spectra model, unrelated to variable stars.
...
**Title Relevance Reason**:  
Quiet-Sun temperature diagnostics, not variable stars.
...
**Title Relevance Reason**:  
High-redshift faint galaxies, unrelated to variable stars.
...
**Title Relevance Reason**:  
Spiral arms in cluster galaxies, unrelated to stellar variability.
...
**Title Relevance Reason**:  
Tidal disruption event simulations, not variable stars.
...
**Title Relevance Reason**:  
Cosmic expansion reconstruction, unrelated to variable stars.
...
**Title Relevance Reason**:  
Experiment control system, not variable stars.
...
**Title Relevance Reason**:  
Data visualization method, no variable-star connection in title.
...
**Title Relevance Reason**:  
Galaxy evolution and black holes, unrelated to variable stars.
...
**Title Relevance Reason**:  
Radio galaxy morphology, not variable stars.
...
**Title Relevance Reason**:  
21-cm power spectrum analysis, unrelated to variable stars.
...
**Title Relevance Reason**:  
Cosmic web identification in clusters, not stellar variability.
...
**Title Relevance Reason**:  
Instrument control software, unrelated to variable stars.
...
**Title Relevance Reason**:  
X-ray telescope performance paper, not variable stars.
...
**Title Relevance Reason**:  
Data analysis pipeline for mission instrument, not variable stars.
...
**Title Relevance Reason**:  
Instrument overview and performance, unrelated to variable stars.
...
**Title Relevance Reason**:  
Transient trigger camera description, not variable stars.
...
**Title Relevance Reason**:  
Science center infrastructure, unrelated to variable stars.
...
**Title Relevance Reason**:  
User support services for mission, not variable stars.
...
**Title Relevance Reason**:  
Science user support paper, unrelated to variable stars.
...
**Title Relevance Reason**:  
Detection plane performance paper, not variable stars.
...
**Title Relevance Reason**:  
Scientific analysis pipeline for GRBs, not variable stars.
...
**Title Relevance Reason**:  
GRB trigger overview, unrelated to variable stars.
...
**Title Relevance Reason**:  
Calibration analysis for mission instrument, not variable stars.
...
**Title Relevance Reason**:  
Mission overview, unrelated to variable stars.
...
**Title Relevance Reason**:  
Ground support system, not variable stars.
...
**Title Relevance Reason**:  
Instrumentation for alerts, unrelated to variable stars.
...
**Title Relevance Reason**:  
Ground-based camera array overview, not variable stars.
...
**Title Relevance Reason**:  
Coded mask hardware paper, unrelated to variable stars.
...
**Title Relevance Reason**:  
Camera in-flight performance, not variable stars.
...
**Title Relevance Reason**:  
Alert network infrastructure, unrelated to variable stars.
...
**Title Relevance Reason**:  
Alert-chain planning system, not variable stars.
...
**Title Relevance Reason**:  
Real-time response system for mission, unrelated to variable stars.
...
**Title Relevance Reason**:  
Data processing and GRB identification, not variable stars.
...
**Title Relevance Reason**:  
Scientific pipeline for gamma-ray monitor, not variable stars.
...
**Title Relevance Reason**:  
Verification and pre-launch testing, unrelated to variable stars.
...
**Title Relevance Reason**:  
Onboard data processing for mission instrument, not variable stars.
...
**Title Relevance Reason**:  
On-ground processing for mission data, unrelated to variable stars.
...
**Title Relevance Reason**:  
Instrumentation on SVOM alerts, not variable stars.
...
**Title Relevance Reason**:  
Joint GRB analysis pipeline, unrelated to variable stars.
...
**Title Relevance Reason**:  
Coronal loop thermal instability, solar plasma topic.
...
**Title Relevance Reason**:  
Simulation data release, not variable stars.
...
**Title Relevance Reason**:  
Data reduction software, unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy redshift uncertainties in cosmology, unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy completeness and profile fitting, not variable stars.
...
**Title Relevance Reason**:  
Orbit determination method, unrelated to variable stars.
...
**Title Relevance Reason**:  
Spectral archive release, not variable stars.
...
**Title Relevance Reason**:  
Hot gaseous halos in simulations, unrelated to variable stars.
...
**Title Relevance Reason**:  
Historical solar eclipse analysis, not variable stars.
...
**Title Relevance Reason**:  
Interstellar molecule detection, unrelated to variable stars.
...
**Title Relevance Reason**:  
Asteroid spin-state prediction, not variable stars.
...
**Title Relevance Reason**:  
Interstellar dust along X-ray source sightline, unrelated to variable stars.
...
**Title Relevance Reason**:  
Mars atmosphere dynamics, not variable stars.
...
**Title Relevance Reason**:  
GRB dust-scattering distances, unrelated to variable stars.
...
**Title Relevance Reason**:  
Weyl potential and cosmological statistics, unrelated to variable stars.
...
**Title Relevance Reason**:  
Inflationary power spectrum module, not variable stars.
...
**Title Relevance Reason**:  
Galaxy kinematics at intermediate redshift, not stellar variability.
...
**Title Relevance Reason**:  
AGN broad-line region dynamics, unrelated to variable stars.
...
**Title Relevance Reason**:  
Magnetar burst nuclei evidence, unrelated to variable stars.
...
**Title Relevance Reason**:  
Interstellar dust depletion and extinction, not variable stars.
...
**Title Relevance Reason**:  
Molecular cloud lifetimes, unrelated to variable stars.
...
**Title Relevance Reason**:  
Lunar descent framework, unrelated to astrophysical variable stars.
...
**Title Relevance Reason**:  
Detector irradiation performance, not variable stars.
...
**Title Relevance Reason**:  
Massive black hole binaries in GW band, unrelated to variable stars.
...
**Title Relevance Reason**:  
Scalar polarization tests in multimessenger events, not variable stars.
...
**Title Relevance Reason**:  
Galactic rotation curves and dark matter, not variable stars.
...
**Title Relevance Reason**:  
Host galaxy prediction for black hole binaries, unrelated to variable stars.
...
**Title Relevance Reason**:  
Radiative transfer theory, not variable stars.
...
**Title Relevance Reason**:  
Dust production and depletion in galaxies, unrelated to variable stars.
...
**Title Relevance Reason**:  
Inflation theory, not variable stars.
...
**Title Relevance Reason**:  
Exoplanet transmission spectroscopy, unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy formation and black hole seeding, unrelated to variable stars.
...
**Title Relevance Reason**:  
Lyman-alpha forest cross-correlations, not variable stars.
...
**Title Relevance Reason**:  
Interstellar object search context, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark energy observational constraints, not variable stars.
...
**Title Relevance Reason**:  
Oort-cloud structures and interstellar comets, unrelated to variable stars.
...
**Title Relevance Reason**:  
Cosmological model comparison, not variable stars.
...
**Title Relevance Reason**:  
Quasar dipole anomaly, unrelated to variable stars.
...
**Title Relevance Reason**:  
JWST galaxy tension, not variable stars.
...
**Title Relevance Reason**:  
Action-space coherence in simulation, unrelated to variable stars.
...
**Title Relevance Reason**:  
Interacting dark energy and black hole superradiance, not variable stars.
...
**Title Relevance Reason**:  
Dark energy constraints, unrelated to variable stars.
...
**Title Relevance Reason**:  
DESI weak lensing cosmology, not variable stars.
...
**Title Relevance Reason**:  
AGN disk capture and merger rates, unrelated to variable stars.
...
**Title Relevance Reason**:  
AGN accretion disks, not variable stars.
...
**Title Relevance Reason**:  
Dark energy and Hubble tension, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark matter halo collapse, not variable stars.
...
**Title Relevance Reason**:  
Weak lensing analysis, unrelated to variable stars.
...
**Title Relevance Reason**:  
Cosmic dipole kinematics, not variable stars.
...
**Title Relevance Reason**:  
Analytic cosmology from galaxy properties, unrelated to variable stars.
...
**Title Relevance Reason**:  
AGN coronae and neutrinos, not variable stars.
...
**Title Relevance Reason**:  
Gamma-ray source catalog, unrelated to variable stars.
...
**Title Relevance Reason**:  
Dwarf spheroidal galaxy dynamics, not variable stars.
...
**Title Relevance Reason**:  
Protoplanetary disc fitting, unrelated to variable stars.
...
**Title Relevance Reason**:  
Supernova feedback in galaxy formation simulations, not variable stars.
...
**Title Relevance Reason**:  
Primordial gas and fuzzy dark matter, unrelated to variable stars.
...
**Title Relevance Reason**:  
High-velocity cloud accretion, not variable stars.
...
**Title Relevance Reason**:  
Slitless grism spectra framework, unrelated to variable stars.
...
**Title Relevance Reason**:  
Cosmic ray electrons in galaxies, not variable stars.
...
**Title Relevance Reason**:  
Mars-moon tidal history, unrelated to variable stars.
...
**Title Relevance Reason**:  
Self-interacting dark matter cosmology, not variable stars.
...
**Title Relevance Reason**:  
Planetary migration topic, unrelated to variable stars.
...
**Title Relevance Reason**:  
SETI/civilization statistics, not variable stars.
...
**Title Relevance Reason**:  
Interstellar chemistry and spectroscopy, unrelated to variable stars.
...
**Title Relevance Reason**:  
Detector energy response study, not variable stars.
...
**Title Relevance Reason**:  
Gamma-ray monitor hardware paper, unrelated to variable stars.
...
**Title Relevance Reason**:  
Multiplanet system stability, not stellar variability.
...
**Title Relevance Reason**:  
Primordial black holes and early-universe non-Gaussianity, not variable stars.
...
**Title Relevance Reason**:  
Planetary nebula discoveries, unrelated to variable stars.
...
**Title Relevance Reason**:  
Cosmological gravitational waves, not variable stars.
...
**Title Relevance Reason**:  
Core-collapse supernova neutrino asymmetry, unrelated to variable stars.
...
**Title Relevance Reason**:  
Iron line profiles from wormholes, not variable stars.
...
**Title Relevance Reason**:  
Solar-wind Alfvén-wave instability, unrelated to variable stars.
...
**Title Relevance Reason**:  
Affine gravity cosmology, unrelated to variable stars.
...
**Title Relevance Reason**:  
Primordial gravitational waves and spinfoams, not variable stars.
...
**Title Relevance Reason**:  
Thermal field theory for plasma, unrelated to variable stars.
...
**Title Relevance Reason**:  
Strong CP symmetry theory, not variable stars.
...
**Title Relevance Reason**:  
Magnetic field dynamics theory, unrelated to variable stars.
...
**Title Relevance Reason**:  
Nonlinear electromagnetic waves in plasmas, not variable stars.
...
**Title Relevance Reason**:  
Axion dark matter detection, unrelated to variable stars.
...
**Title Relevance Reason**:  
Self-force waveforms for inspirals, not variable stars.
...
**Title Relevance Reason**:  
Dark matter freeze-in model, unrelated to variable stars.
...
**Title Relevance Reason**:  
Extreme-mass-ratio inspirals, not variable stars.
...
**Title Relevance Reason**:  
Dark matter direct-detection benchmarks, unrelated to variable stars.
...
**Title Relevance Reason**:  
Black hole shadow morphology, not variable stars.
