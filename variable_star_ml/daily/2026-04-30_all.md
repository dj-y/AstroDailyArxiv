...
**Title Relevance Reason**:  
Acoustic mode amplitudes in solar-like stars relate to stellar oscillations, adjacent to pulsating-star physics though not clearly a variable-star survey or ML study.
...
**Title Relevance Reason**:  
X-ray binaries can be strongly variable stellar systems, but the title is broad accretion-wind physics rather than light-curve analysis or classification.
...
**Title Relevance Reason**:  
Be X-ray binaries are variable systems, but the title emphasizes population synthesis rather than observed variability or light-curve modeling.
...
**Title Relevance Reason**:  
Binary evolution can overlap with eclipsing/interacting binaries, but title is theory-focused and not clearly on variability or light curves.
...
**Title Relevance Reason**:  
Characterizing non-transients in a high-cadence survey is time-domain adjacent, but not specifically variable stars from the title.
...
**Title Relevance Reason**:  
Machine learning on stellar spectra and chemical inference is methodologically adjacent, but not focused on variable stars or light curves.
...
**Title Relevance Reason**:  
Metal-poor halo star abundances touch stellar metallicity, but not variable stars or photometric inference.
...
**Title Relevance Reason**:  
Machine learning classification is relevant in method, but applied to gamma-ray bursts rather than variable stars.
...
**Title Relevance Reason**:  
Lightcurve inversion is a relevant method keyword, but applied to an asteroid, not stars.
...
**Title Relevance Reason**:  
Transit timing and radial velocities concern exoplanets, not variable stars.
...
**Title Relevance Reason**:  
Ultracool dwarf parameters are stellar, but no indication of variability, time series, or variable-star inference.
...
**Title Relevance Reason**:  
Close white dwarf binaries are stellar binaries, but this is tidal disruption by black holes rather than variable-star observation/modeling.
...
**Title Relevance Reason**:  
Photometric variability appears, but in changing-look AGN, not variable stars.
...
**Title Relevance Reason**:  
OB association census is stellar-population work, but not specifically about variable stars.
...
**Title Relevance Reason**:  
ANN methods are mentioned, but applied to cosmology rather than variable stars.
...
**Title Relevance Reason**:  
Machine learning density estimation is methodologically related, but applied to gravitational-wave searches, not variable stars.
...
**Title Relevance Reason**:  
O-type star nitrogen abundances and binary interaction are stellar, but not about variability or time-series analysis.
...
**Title Relevance Reason**:  
Massive main-sequence star evolution in population synthesis is stellar, but not about variability or light-curve analysis.
...
**Title Relevance Reason**:  
Circumbinary discs around supernova progenitors involve binaries, but not variable-star light curves or classification.
...
**Title Relevance Reason**:  
Polarization angle variability is about blazar flares, not stellar variability.
...
**Title Relevance Reason**:  
Spectroscopic variability is mentioned, but for a high-redshift galaxy/AGN context, not variable stars.
...
**Title Relevance Reason**:  
Binary fraction in galaxies is about stellar populations, not variable-star behavior.
...
**Title Relevance Reason**:  
Star formation theory for Population III stars, not variable-star observations or modeling.
...
**Title Relevance Reason**:  
Solar active region evolution uses tracking methods, but not variable stars or stellar light curves.
...
**Title Relevance Reason**:  
Binary pulsar timing is compact-object timing, not variable-star light-curve analysis.
...
**Title Relevance Reason**:  
Periodic behavior is mentioned, but in solar radio bursts rather than variable stars.
...
**Title Relevance Reason**:  
Black hole accretion surrogate modeling; not about variable stars or stellar light curves.
...
**Title Relevance Reason**:  
Apsidal clustering is orbital dynamics, not stellar variability or variable-star inference.
...
**Title Relevance Reason**:  
Black hole merger populations in AGN disks; unrelated to variable stars.
...
**Title Relevance Reason**:  
Relativistic jet physics, not stellar variability studies.
...
**Title Relevance Reason**:  
Dust grain alignment and polarization theory; unrelated to variable stars.
...
**Title Relevance Reason**:  
Soft X-ray sky foreground contribution; not about variable stars.
...
**Title Relevance Reason**:  
Globular cluster dynamics, not stellar variability or light curves.
...
**Title Relevance Reason**:  
Weak lensing cosmography; unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark matter halo density profiles and baryonic effects; not relevant to variable stars.
...
**Title Relevance Reason**:  
Gaseous halos of radio galaxies; unrelated to stellar variability.
...
**Title Relevance Reason**:  
Galaxy environments, not variable stars.
...
**Title Relevance Reason**:  
Dark matter annihilation signal boosts in cosmic web; unrelated to variable stars.
...
**Title Relevance Reason**:  
Detector charge diffusion for Roman telescope; instrumentation only.
...
**Title Relevance Reason**:  
Solar wind/current sheet plasma observations; not variable stars.
...
**Title Relevance Reason**:  
Relativistic reconnection particle spectra; unrelated to variable stars.
...
**Title Relevance Reason**:  
Gas and dust in a quiescent galaxy at z=2; not variable stars.
...
**Title Relevance Reason**:  
Hubble-constant mock data challenge using spectral sirens; unrelated to variable stars.
...
**Title Relevance Reason**:  
Celestial pole offset prediction; unrelated to stellar variability.
...
**Title Relevance Reason**:  
Coronal mass ejection evolution; solar physics, not variable stars.
...
**Title Relevance Reason**:  
Ly-alpha emission during reionization; unrelated to variable stars.
...
**Title Relevance Reason**:  
Laser interferometry wavefront error modeling; instrumentation, not variable stars.
...
**Title Relevance Reason**:  
HI-halo mass relation in galaxies; unrelated to variable stars.
...
**Title Relevance Reason**:  
Tidal heating of stellar clusters in fuzzy dark matter halos; not about variable stars.
...
**Title Relevance Reason**:  
Magnetar evolution and nuclear physics; not variable stars.
...
**Title Relevance Reason**:  
Modified-gravity spherical collapse; unrelated to variable stars.
...
**Title Relevance Reason**:  
Chemistry in TMC-1 molecular cloud; not variable stars.
...
**Title Relevance Reason**:  
GeV emission from a millisecond pulsar; not variable-star light-curve work.
...
**Title Relevance Reason**:  
Inflation and gravitational waves; unrelated to variable stars.
...
**Title Relevance Reason**:  
Cosmology and Hubble tension; not relevant to variable stars.
...
**Title Relevance Reason**:  
Fast radio burst cosmological evolution; unrelated to variable stars.
...
**Title Relevance Reason**:  
Ice-core constraints on the Carrington event; not variable stars.
...
**Title Relevance Reason**:  
Solar turbulence and coronal heating; not variable stars.
...
**Title Relevance Reason**:  
Galaxy shape distributions for Euclid calibration; unrelated to variable stars.
...
**Title Relevance Reason**:  
Cosmological redshift drift; not relevant to variable stars.
...
**Title Relevance Reason**:  
Barred galaxy simulations and density waves; unrelated to variable stars.
...
**Title Relevance Reason**:  
Obscured active galactic nucleus; not variable stars.
...
**Title Relevance Reason**:  
Dust enrichment from supernovae; unrelated to variable stars.
...
**Title Relevance Reason**:  
Instrument commissioning and first results; not clearly about variable stars.
...
**Title Relevance Reason**:  
Neutrino telescope real-time analysis framework; unrelated to variable stars.
...
**Title Relevance Reason**:  
Dust evolution in protoplanetary disks; unrelated to variable stars.
...
**Title Relevance Reason**:  
Reconstructing cosmological initial conditions from surveys; not variable stars.
...
**Title Relevance Reason**:  
Exoplanet atmosphere/isotopologue observations; unrelated to variable stars.
...
**Title Relevance Reason**:  
Power spectrum estimation methods for radio data; not about variable stars.
...
**Title Relevance Reason**:  
HI galaxy counts and clustering; unrelated to variable stars.
...
**Title Relevance Reason**:  
21 cm intensity mapping component separation; not variable stars.
...
**Title Relevance Reason**:  
Warm Jupiter cloud feedback and spectra; unrelated to variable stars.
...
**Title Relevance Reason**:  
Subsolar-mass mergers in collapsar disks; not variable stars.
...
**Title Relevance Reason**:  
Modified gravity with DESI; unrelated to variable stars.
...
**Title Relevance Reason**:  
Biosignature detection and spectral resolution; not variable stars.
...
**Title Relevance Reason**:  
Satellite galaxy baryonic content in simulations; unrelated to variable stars.
...
**Title Relevance Reason**:  
Bouncing cosmologies; not relevant to variable stars.
...
**Title Relevance Reason**:  
Black hole signatures in dark matter halo; unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark matter detector prospects; not variable stars.
...
**Title Relevance Reason**:  
Primordial black holes as dark matter; unrelated to variable stars.
...
**Title Relevance Reason**:  
Extreme-mass-ratio inspiral parameter bias; not variable stars.
...
**Title Relevance Reason**:  
Neutrino millicharge constraints from supernova neutrinos; unrelated to variable stars.
...
**Title Relevance Reason**:  
Monopole bag gravitational properties; unrelated to variable stars.
...
**Title Relevance Reason**:  
Black hole encounters and radiation; not variable stars.
...
**Title Relevance Reason**:  
Periodic orbit approximation in dynamical systems; not stellar variability.
...
**Title Relevance Reason**:  
Vacuum decay theory; unrelated to variable stars.
...
**Title Relevance Reason**:  
Neutron stars and dense matter; not variable stars.
...
**Title Relevance Reason**:  
Neutron-star outer-crust equation of state; unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy catalogue completeness for dark sirens; unrelated to variable stars.
...
**Title Relevance Reason**:  
Matter distribution in cosmic web simulations; not variable stars.
...
**Title Relevance Reason**:  
AGN jet evolution simulation; unrelated to variable stars.
...
**Title Relevance Reason**:  
Cosmic-ray MHD galaxy-scale models; not variable stars.
...
**Title Relevance Reason**:  
Abundance gradients in quiescent galaxies; unrelated to variable stars.
...
**Title Relevance Reason**:  
Stochastic gravitational waves from reheating; not variable stars.
...
**Title Relevance Reason**:  
Generic multiscale timestepping methods; no variable-star application indicated.
...
**Title Relevance Reason**:  
JWST interferometer calibration; instrumentation only.
...
**Title Relevance Reason**:  
Core-collapse supernova simulations and signatures; not variable stars.
...
**Title Relevance Reason**:  
Black hole imaging and polarimetry; unrelated to variable stars.
...
**Title Relevance Reason**:  
Strong lensing and extinction maps of a supernova host galaxy; not variable stars.
...
**Title Relevance Reason**:  
Beam mapping robot development; instrumentation, not variable stars.
...
**Title Relevance Reason**:  
Galactic disk spiral mode formation; unrelated to variable stars.
...
**Title Relevance Reason**:  
Galaxy population distribution via halo dynamics; not variable stars.
...
**Title Relevance Reason**:  
Planet imaging coronagraph instrument; unrelated to variable stars.
...
**Title Relevance Reason**:  
Equation of state constraints for dense matter; unrelated to variable stars.
...
**Title Relevance Reason**:  
Cosmological constraints from gravitational-wave sirens; unrelated to variable stars.
...
**Title Relevance Reason**:  
FRB dispersion measure modeling; unrelated to variable stars.
...
**Title Relevance Reason**:  
Galactic disk structural breaks; not variable stars.
...
**Title Relevance Reason**:  
Coronal mass ejection tomography; solar physics, not variable stars.
...
**Title Relevance Reason**:  
Spin distribution of stellar black holes in clusters; unrelated to variable stars.
...
**Title Relevance Reason**:  
Continuous gravitational wave localization; not variable stars.
...
**Title Relevance Reason**:  
Large-scale structure from gamma-ray bursts; unrelated to variable stars.
...
**Title Relevance Reason**:  
Dark energy and high-redshift galaxies; not variable stars.
...
**Title Relevance Reason**:  
Filament linear density in molecular clouds; unrelated to variable stars.
...
**Title Relevance Reason**:  
Pair halos from blazar jets; unrelated to variable stars.
...
**Title Relevance Reason**:  
Three-body problem level surfaces; unrelated to variable stars.
...
**Title Relevance Reason**:  
Cluster dynamics and modified gravity; unrelated to variable stars.
...
**Title Relevance Reason**:  
Simulation data release for cosmology; not variable stars.
...
**Title Relevance Reason**:  
Gas accretion onto galaxy clusters in simulations; unrelated to variable stars.
...
**Title Relevance Reason**:  
Cosmological parameter recovery from gravitational-wave mock data; not variable stars.
...
**Title Relevance Reason**:  
Modified dispersion tests with black-hole binaries; unrelated to variable stars.
...
**Title Relevance Reason**:  
Gravitational-wave background detection with clocks; unrelated to variable stars.
...
**Title Relevance Reason**:  
Periodic motions in Earth-Moon three-body problem; not stellar variability.
...
**Title Relevance Reason**:  
Black hole solutions with cosmological hair; unrelated to variable stars.
...
**Title Relevance Reason**:  
Testing dark energy with black hole ringdown; not variable stars.
