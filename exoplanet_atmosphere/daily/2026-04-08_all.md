...
**Title Relevance Reason**:  
Atmospheric retrieval with JWST is highly relevant methodologically, but the targets are brown dwarfs rather than exoplanets.
...
**Title Relevance Reason**:  
Transit photometry and characterization of transiting exoplanets is adjacent, but not specifically atmospheric spectroscopy or retrieval.
...
**Title Relevance Reason**:  
JWST exoplanet system paper, but about exomoons and ephemerides rather than atmospheres.
...
**Title Relevance Reason**:  
Disk chemistry around young stars may inform planet composition origins, but not exoplanet atmospheric characterization.
...
**Title Relevance Reason**:  
Earth-like planet migration and debris disks are planet-formation related, but not atmospheric characterization.
...
**Title Relevance Reason**:  
Planetary dynamics of resonant chains could be tangentially relevant to exoplanet systems, but not atmospheres.
...
**Title Relevance Reason**:  
Includes planets in the context of young stars, but not atmospheric characterization.
...
**Title Relevance Reason**:  
Protoplanetary disk dust polarization and streaming instability, only indirectly related to planet formation.
...
**Title Relevance Reason**:  
Absorption and spectral transmittance are atmospheric-sounding concepts, but this is about intergalactic medium, not exoplanets.
...
**Title Relevance Reason**:  
Early planet formation in disks is only indirectly relevant to exoplanet properties, not atmospheric studies.
...
**Title Relevance Reason**:  
High-contrast imaging of Cepheids, unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Mentions planetary-mass companions, but in gravitational-wave detectability around compact stars, not atmospheres.
...
**Title Relevance Reason**:  
Broad astronomical object sequence including planets, but not about exoplanet atmospheres.
...
**Title Relevance Reason**:  
Wavefront control is instrumentation-related and could indirectly matter for observations, but not specifically exoplanet atmospheres.
...
**Title Relevance Reason**:  
CO2 molecular excited-state calculations could be chemically relevant in principle, but the title is not about exoplanet atmospheres.
...
**Title Relevance Reason**:  
Accretion disc winds involve outflow physics, but in X-ray binaries rather than exoplanet atmospheres.
...
**Title Relevance Reason**:  
About photographic plate transients and geomagnetic storms, unrelated to exoplanets or atmospheres.
...
**Title Relevance Reason**:  
Gravitational-wave inference paper, not related to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Failed supernova observations, unrelated to exoplanet atmosphere studies.
...
**Title Relevance Reason**:  
Compact-object mergers in AGN disks, not relevant to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Massive quiescent galaxies with NIRCam imaging, unrelated topic.
...
**Title Relevance Reason**:  
Star formation histories of galaxies, not connected to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Gamma-ray emission from AGN, unrelated to exoplanet atmospheric observations or modeling.
...
**Title Relevance Reason**:  
Eclipsing binaries calibration work, not relevant to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Dark matter density profiles of filaments, unrelated.
...
**Title Relevance Reason**:  
Short GRB and neutron-star merger rates, unrelated to exoplanets.
...
**Title Relevance Reason**:  
Crab X-ray pulse statistics, unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Relativistic plasma theory paper, not relevant to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Neutron star mergers and gamma-ray bursts, unrelated topic.
...
**Title Relevance Reason**:  
Tests of gravity near black holes, not relevant to exoplanets.
...
**Title Relevance Reason**:  
Cosmic baryon large-scale structure paper, unrelated.
...
**Title Relevance Reason**:  
Cosmological parameter tension paper, not connected to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Radio counterpart to a supernova, unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Galaxy inflow signatures via Balmer decrement, unrelated.
...
**Title Relevance Reason**:  
Supernova radiative-transfer modeling, not related to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Fourier transform approximation for ring-like images, unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Primordial non-Gaussianity and DESI cross-correlations, unrelated.
...
**Title Relevance Reason**:  
Lensed quasar dark matter survey, unrelated.
...
**Title Relevance Reason**:  
Early-universe radiation injection constraints, not relevant.
...
**Title Relevance Reason**:  
Machine learning interpretability for CMB maps, unrelated.
...
**Title Relevance Reason**:  
Neural-network framework for cluster completeness in galaxies, unrelated.
...
**Title Relevance Reason**:  
Solar coronal streamer blob statistics, unrelated.
...
**Title Relevance Reason**:  
Catalog of mid-infrared variable sources, unrelated.
...
**Title Relevance Reason**:  
Polarization calibration for OH megamasers, unrelated.
...
**Title Relevance Reason**:  
Binary star mass loss paper, unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Neutron star observable reconstruction, unrelated.
...
**Title Relevance Reason**:  
Pulsar timing dataset analysis, unrelated.
...
**Title Relevance Reason**:  
Matter-density profile and supernova/BAO cosmology, unrelated.
...
**Title Relevance Reason**:  
Radio galaxy evolution paper, not relevant.
...
**Title Relevance Reason**:  
Neutron-star matter clustering, unrelated.
...
**Title Relevance Reason**:  
HI systems toward a quasar, unrelated to exoplanets.
...
**Title Relevance Reason**:  
Searching for contact binaries, unrelated.
...
**Title Relevance Reason**:  
Black-hole merger recoil and host environments, unrelated.
...
**Title Relevance Reason**:  
HI depletion times in galaxies, unrelated.
...
**Title Relevance Reason**:  
Galaxy clustering and halo connections, unrelated.
...
**Title Relevance Reason**:  
Blazar catalog release, unrelated.
...
**Title Relevance Reason**:  
Dark matter subhalo merging, unrelated.
...
**Title Relevance Reason**:  
Optical spectra of galaxies and outflows, unrelated.
...
**Title Relevance Reason**:  
Stellar populations in early-type galaxies, unrelated.
...
**Title Relevance Reason**:  
Non-LTE ionization in neutron star merger ejecta, unrelated.
...
**Title Relevance Reason**:  
Detector instrumentation for gravitational waves, unrelated.
...
**Title Relevance Reason**:  
Kilonova spectral feature modeling, unrelated.
...
**Title Relevance Reason**:  
Axion signals from supernovae, unrelated.
...
**Title Relevance Reason**:  
FLRW consistency relations in cosmology, unrelated.
...
**Title Relevance Reason**:  
Galaxy cluster lensing selection bias, unrelated.
...
**Title Relevance Reason**:  
Cosmology consistency tests, unrelated.
...
**Title Relevance Reason**:  
Dark energy evolution analysis, unrelated.
...
**Title Relevance Reason**:  
Comment on solar gamma-ray production, unrelated.
...
**Title Relevance Reason**:  
Pre-supernova neutrino support software, unrelated.
...
**Title Relevance Reason**:  
X-ray periodicity in a blazar, unrelated.
...
**Title Relevance Reason**:  
Spectroscopic survey of dense cores, unrelated.
...
**Title Relevance Reason**:  
Overcontact binary inclination estimates, unrelated.
...
**Title Relevance Reason**:  
Parity tests with galaxy spectra, unrelated.
...
**Title Relevance Reason**:  
AMR optimization for cosmological simulations, unrelated.
...
**Title Relevance Reason**:  
Lyman-alpha forest and dark matter, unrelated.
...
**Title Relevance Reason**:  
Dual and offset quasars, unrelated.
...
**Title Relevance Reason**:  
Dark matter with Einstein Telescope, unrelated.
...
**Title Relevance Reason**:  
ACS/WFC instrumental sensitivity calibration, unrelated.
...
**Title Relevance Reason**:  
Black hole metric distinguishability to EHT, unrelated.
...
**Title Relevance Reason**:  
Photometric redshift training with DESI spectroscopy, unrelated.
...
**Title Relevance Reason**:  
Convection model testing using the Sun, unrelated.
...
**Title Relevance Reason**:  
Resonance stability in rotational dynamics, unrelated.
...
**Title Relevance Reason**:  
Gravitational mirroring near compact objects, unrelated.
...
**Title Relevance Reason**:  
Dark matter model for gamma-ray excess, unrelated.
...
**Title Relevance Reason**:  
Ion Weibel instability simulation framework, unrelated.
...
**Title Relevance Reason**:  
Gravitational waves from scalar-field perturbations, unrelated.
...
**Title Relevance Reason**:  
Cosmological collider signals and CP breaking, unrelated.
...
**Title Relevance Reason**:  
Black hole thick disk torus modeling, unrelated.
...
**Title Relevance Reason**:  
Space plasma instabilities, unrelated.
...
**Title Relevance Reason**:  
Detector noise budget for gravitational-wave instrument, unrelated.
...
**Title Relevance Reason**:  
GPU neighbor-search software for simulations, unrelated.
...
**Title Relevance Reason**:  
Field coupling and gravitational potential theory, unrelated.
...
**Title Relevance Reason**:  
Gravitational-wave population statistics, unrelated.
...
**Title Relevance Reason**:  
Bispectrum theory paper, unrelated.
...
**Title Relevance Reason**:  
BBN photon distributions, unrelated.
...
**Title Relevance Reason**:  
Cosmological simulations of stellar halos, unrelated.
...
**Title Relevance Reason**:  
Spectral imaging with QUBIC for cosmology instrumentation, unrelated.
...
**Title Relevance Reason**:  
Markarian 501 VHE flaring behavior, unrelated.
...
**Title Relevance Reason**:  
Strong lensing and high-redshift detections with JWST, but not exoplanet atmospheres.
...
**Title Relevance Reason**:  
Inflation and reheating implications, unrelated.
...
**Title Relevance Reason**:  
Millisecond pulsar plus subdwarf B formation scenario, unrelated.
...
**Title Relevance Reason**:  
Initial mass function and galaxy chemical evolution, unrelated.
...
**Title Relevance Reason**:  
Fast radio burst morphology with deep learning, unrelated.
...
**Title Relevance Reason**:  
Dark matter testing with stellar streams, unrelated.
...
**Title Relevance Reason**:  
Black hole-neutron star mergers, unrelated.
...
**Title Relevance Reason**:  
Clumpy galaxies in JADES, unrelated.
...
**Title Relevance Reason**:  
Blazars as neutrino sources, unrelated.
...
**Title Relevance Reason**:  
Fuzzy dark matter and globular clusters, unrelated.
...
**Title Relevance Reason**:  
Metallicity gradients in cosmological simulations of galaxies, unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
X-ray supernova analysis pipeline, unrelated.
...
**Title Relevance Reason**:  
Interacting dark energy and black hole superradiance, unrelated.
...
**Title Relevance Reason**:  
Milky Way dark matter density profiles, unrelated.
...
**Title Relevance Reason**:  
Optical polarimetry of an X-ray binary, unrelated.
...
**Title Relevance Reason**:  
Protostellar variability in massive protoclusters, unrelated.
...
**Title Relevance Reason**:  
Cygnus X-3 gamma-ray source, unrelated.
...
**Title Relevance Reason**:  
Supernova progenitor constraints and ejecta asymmetries, unrelated.
...
**Title Relevance Reason**:  
Dark galaxy predictions in Local Group simulations, unrelated.
...
**Title Relevance Reason**:  
VLBI observations of a supernova radio source, unrelated.
...
**Title Relevance Reason**:  
Spectroscopic confirmation of a high-redshift galaxy, unrelated.
...
**Title Relevance Reason**:  
Vacuum birefringence in magnetars, unrelated.
...
**Title Relevance Reason**:  
Accreted stellar halos around Milky Way-like galaxies, unrelated.
...
**Title Relevance Reason**:  
Negative mass cosmology paper, unrelated.
...
**Title Relevance Reason**:  
Galactic interstellar medium electron density model, unrelated.
...
**Title Relevance Reason**:  
Perseus cluster stellar metallicity dependence, unrelated.
...
**Title Relevance Reason**:  
Chemical composition in Perseus cluster and galaxies, unrelated.
...
**Title Relevance Reason**:  
FRB scattering through CGM, unrelated.
...
**Title Relevance Reason**:  
AGN-driven metallicity enrichment in a galaxy ISM, unrelated.
...
**Title Relevance Reason**:  
Coronal radius variation in a tidal disruption event, unrelated.
...
**Title Relevance Reason**:  
Coronal electron distribution diagnostics, unrelated.
...
**Title Relevance Reason**:  
BL Lacertae gamma-ray variability, unrelated.
...
**Title Relevance Reason**:  
Triggered star formation in ALMAGAL source, unrelated.
...
**Title Relevance Reason**:  
Dark energy and pre-recombination physics, unrelated.
...
**Title Relevance Reason**:  
Foundational model for radio astronomy, unrelated.
...
**Title Relevance Reason**:  
Euclid strong lens spectroscopic redshifts, unrelated.
...
**Title Relevance Reason**:  
Dark energy parameterization and Planck smoothing, unrelated.
...
**Title Relevance Reason**:  
Gauss-Bonnet inflation theory, unrelated.
...
**Title Relevance Reason**:  
Gas motions in filaments, unrelated.
...
**Title Relevance Reason**:  
Gravitational waveform resummation, unrelated.
...
**Title Relevance Reason**:  
Dark matter velocity distributions for direct detection, unrelated.
...
**Title Relevance Reason**:  
Higher-dimensional gravitational Raman scattering, unrelated.
...
**Title Relevance Reason**:  
Teaching astronomy with LLMs, unrelated.
...
**Title Relevance Reason**:  
Quantum corrections to fifth-force profiles, unrelated.
...
**Title Relevance Reason**:  
Axion-like dark matter detectability in GW detectors, unrelated.
...
**Title Relevance Reason**:  
Primordial black hole evaporation in a thermal universe, unrelated.
