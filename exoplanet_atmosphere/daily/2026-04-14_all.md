...
**Title Relevance Reason**:  
Super-Earth and sub-Neptune characterization is relevant to exoplanet science and likely adjacent to atmospheric studies, though the title is broad.
...
**Title Relevance Reason**:  
Exoplanet transit-search methodology is relevant to exoplanet science, though not specifically to atmosphere characterization.
...
**Title Relevance Reason**:  
Candidate exoplanet detections are relevant to exoplanet science, but the title is not about atmospheres.
...
**Title Relevance Reason**:  
About an exoplanet system (GJ 436) but focuses on dynamics and perturbers rather than atmospheric characterization.
...
**Title Relevance Reason**:  
Dust-to-planets chemistry is broadly relevant to planetary composition, but not directly to exoplanet atmosphere observation or retrieval.
...
**Title Relevance Reason**:  
Giant planet ring formation is planetary-system related, but not about atmospheric spectroscopy or retrieval.
...
**Title Relevance Reason**:  
Infrared spectral composition inference for astronomical ices is methodologically adjacent, but not focused on exoplanet atmospheres.
...
**Title Relevance Reason**:  
Hydrogen-neon mixture properties could be broadly relevant to planetary physics, but not specifically exoplanet atmosphere observations or retrievals.
...
**Title Relevance Reason**:  
Disk chemistry and ice sublimation are planet-formation related, but not directly about exoplanet atmospheres.
...
**Title Relevance Reason**:  
Volatile evolution and molecular observations of a comet are chemically adjacent, but not about exoplanet atmospheres.
...
**Title Relevance Reason**:  
Exocomets are part of planetary systems, but this is not about exoplanet atmospheres or spectroscopy.
...
**Title Relevance Reason**:  
Protoplanetary disk instabilities are adjacent to planet formation, but not to exoplanet atmosphere characterization.
...
**Title Relevance Reason**:  
Planet-forming disks are relevant to planetary systems, but not specifically exoplanet atmospheres.
...
**Title Relevance Reason**:  
Atomic line opacities and radiative transfer are broadly relevant methods, but the title is not specifically about exoplanet atmospheres.
...
**Title Relevance Reason**:  
Photometric measurement of ice column density is spectroscopy-related, but not about exoplanet atmospheres.
...
**Title Relevance Reason**:  
Surface processes on Europa are planetary-science related, but not exoplanet atmosphere characterization.
...
**Title Relevance Reason**:  
ALMA observations of disks are relevant to planet formation, but not to exoplanet atmospheres or transmission spectroscopy.
...
**Title Relevance Reason**:  
Protoplanetary disk stability is adjacent to planet formation, but not to exoplanet atmosphere spectroscopy or retrieval.
...
**Title Relevance Reason**:  
Solar System mass inventory is planetary-science related, but not about exoplanet atmospheres.
...
**Title Relevance Reason**:  
Haze formation is atmosphere-related, but for Pluto rather than exoplanets.
...
**Title Relevance Reason**:  
Outer planet moon plasma interactions are planetary, but not about exoplanet atmospheres.
...
**Title Relevance Reason**:  
Protostellar disk fragmentation and flares are unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Spectroscopy instrumentation is broadly relevant, but the title is not specific to exoplanet atmosphere work.
...
**Title Relevance Reason**:  
General data-analysis methodology with astrophysics applications, but not specifically exoplanet atmospheres.
...
**Title Relevance Reason**:  
General uncertainty inference methodology may be broadly useful, but it is not specifically about exoplanet atmospheres.
...
**Title Relevance Reason**:  
Uses JWST and dust spectral fitting, but for AGN obscuring dust rather than exoplanet atmospheres.
...
**Title Relevance Reason**:  
Contains JWST and dust spectroscopy, but it is about a Type Ia supernova, not exoplanets.
...
**Title Relevance Reason**:  
Mars-moon tidal evolution is Solar System dynamics, not exoplanet atmospheres.
...
**Title Relevance Reason**:  
Mentions atmospheres, but these are stellar atmospheres in cosmic-ray interactions, not exoplanet atmospheres.
...
**Title Relevance Reason**:  
JWST spectroscopy is present, but this paper is about early galaxies, not exoplanet atmospheres.
...
**Title Relevance Reason**:  
Uses JWST, but focuses on galaxy thin-disc assembly rather than exoplanet atmospheres.
...
**Title Relevance Reason**:  
Literature mining in astronomy is general methodology, not specifically exoplanet atmosphere research.
...
**Title Relevance Reason**:  
Uses JWST, but studies a Herbig-Haro object rather than exoplanets or their atmospheres.
...
**Title Relevance Reason**:  
Ultra-diffuse galaxies and MOND are unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
X-ray spectroscopy of an AGN corona is unrelated to exoplanet atmosphere studies.
...
**Title Relevance Reason**:  
Primordial black holes and dark matter constraints are unrelated to the topic.
...
**Title Relevance Reason**:  
High-redshift dust attenuation in galaxies is not about exoplanet atmospheres.
...
**Title Relevance Reason**:  
Millisecond pulsar eccentricities are unrelated to exoplanet atmosphere work.
...
**Title Relevance Reason**:  
Gaia astrometry of stellar variability is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Magnetic fields in dense cores concern star formation, not exoplanet atmospheres.
...
**Title Relevance Reason**:  
Black-hole mass gap repopulation in a globular cluster is unrelated.
...
**Title Relevance Reason**:  
Quasi-periodic eruptions and orbital models are unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
X-ray spectroscopy of a cataclysmic variable is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
White dwarf and stellar companion characterization is unrelated to the topic.
...
**Title Relevance Reason**:  
Circumbinary disk mass loss near Sgr A* is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
21 cm calibration instrumentation is unrelated to exoplanet atmosphere studies.
...
**Title Relevance Reason**:  
Galactic archaeology survey work is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Magnetic fields in red giants are unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Core-collapse supernova progenitor perturbations are unrelated.
...
**Title Relevance Reason**:  
YSO jet modeling concerns star formation, not exoplanet atmosphere characterization.
...
**Title Relevance Reason**:  
Planetary-nebula nuclei spectroscopy is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Ring galaxies in voids are unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Pulsars and fast radio bursts are unrelated to the topic.
...
**Title Relevance Reason**:  
Protostar luminosity estimation is unrelated to exoplanet atmosphere studies.
...
**Title Relevance Reason**:  
Dark compact objects and neutron star cores are unrelated.
...
**Title Relevance Reason**:  
Solar flare and CME prediction is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Solar radio index prediction is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Star-galaxy classification is unrelated to the topic.
...
**Title Relevance Reason**:  
Intergalactic magnetic field constraints from gamma-ray bursts are unrelated.
...
**Title Relevance Reason**:  
Cosmic-dawn starbursts and globular cluster formation are unrelated.
...
**Title Relevance Reason**:  
Magnetar observations are unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
A solar telescope seeing monitor is unrelated to exoplanet atmosphere research.
...
**Title Relevance Reason**:  
Inflationary magnetogenesis is unrelated to the topic.
...
**Title Relevance Reason**:  
Solar magnetic field spatial scales are unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Inflation formalism is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
White dwarf helium line profiles are unrelated to exoplanet atmosphere characterization.
...
**Title Relevance Reason**:  
Lorentz invariance tests with AGN flares are unrelated.
...
**Title Relevance Reason**:  
Reflector antenna array solver work is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Milky Way halo tomography is unrelated to the topic.
...
**Title Relevance Reason**:  
Milky Way and LMC orbital history are unrelated.
...
**Title Relevance Reason**:  
Sagittarius A* polarization variability is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Gamma-ray burst high-energy emission is unrelated.
...
**Title Relevance Reason**:  
Common-envelope ejection in massive binaries is unrelated.
...
**Title Relevance Reason**:  
Magnetar X-ray polarization studies are unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Intervening metal absorption and cosmological simulations are unrelated.
...
**Title Relevance Reason**:  
Searching GRB counterparts to FRBs is unrelated to the topic.
...
**Title Relevance Reason**:  
AGB star ages and masses are unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Disk galaxy vertical structure is unrelated.
...
**Title Relevance Reason**:  
Solar flare magnetic reconnection is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Helioseismic oscillations are unrelated to the topic.
...
**Title Relevance Reason**:  
Molecular cloud turbulence is unrelated to exoplanet atmosphere work.
...
**Title Relevance Reason**:  
Reionization topology and dark matter are unrelated.
...
**Title Relevance Reason**:  
MOND modeling of the Bullet Cluster is unrelated.
...
**Title Relevance Reason**:  
Solar flare X-ray classification is unrelated to the topic.
...
**Title Relevance Reason**:  
RR Lyrae stars in stellar streams are unrelated.
...
**Title Relevance Reason**:  
Neutrino emission from NGC 1068 is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Pulsar scintillation and plasma lensing are unrelated.
...
**Title Relevance Reason**:  
BAO tension is cosmology, unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Earth rotation and lunar nutation are unrelated.
...
**Title Relevance Reason**:  
White dwarfs with infrared excess are unrelated to exoplanet atmosphere characterization.
...
**Title Relevance Reason**:  
Rapidly rotating star properties are unrelated.
...
**Title Relevance Reason**:  
Orbital transport engineering is unrelated to astrophysical exoplanet atmosphere studies.
...
**Title Relevance Reason**:  
Cosmic backreaction constraints are unrelated.
...
**Title Relevance Reason**:  
TeV gamma-ray source comparisons are unrelated.
...
**Title Relevance Reason**:  
Solar flare Balmer continuum studies are unrelated.
...
**Title Relevance Reason**:  
Helium giant branch evolution is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Open cluster chemistry is unrelated.
...
**Title Relevance Reason**:  
Gamma-ray emission from a supernova remnant field is unrelated.
...
**Title Relevance Reason**:  
Gamma-ray flare in 3C 120 is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Timing tests for double-white-dwarf transients are unrelated.
...
**Title Relevance Reason**:  
Solar dipole simulations are unrelated.
...
**Title Relevance Reason**:  
Microlensing through ultra diffuse galaxies is unrelated.
...
**Title Relevance Reason**:  
Molecular layering in a dusty streamer is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
The title is too generic and does not indicate relevance to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Filament density structure in molecular clouds is unrelated.
...
**Title Relevance Reason**:  
Near-Keplerian torus modes in galactic nuclei are unrelated.
...
**Title Relevance Reason**:  
21-cm cosmology and Pop III X-ray binaries are unrelated.
...
**Title Relevance Reason**:  
Solar/stellar Ca II magnetic sensitivity is unrelated to exoplanet atmosphere studies.
...
**Title Relevance Reason**:  
Neutron star mass-radius posteriors are unrelated.
...
**Title Relevance Reason**:  
Inverse FIP-effect plasma models are unrelated.
...
**Title Relevance Reason**:  
Solar prominence diagnostics are unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Little red dots are unrelated to exoplanet atmosphere research.
...
**Title Relevance Reason**:  
Cosmological halo clustering inference is unrelated.
...
**Title Relevance Reason**:  
Black hole X-ray binary flare observations are unrelated.
...
**Title Relevance Reason**:  
Open cluster observations are unrelated.
...
**Title Relevance Reason**:  
Supercritical accretion disk theory is unrelated.
...
**Title Relevance Reason**:  
Earth-Moon orbital stability is unrelated.
...
**Title Relevance Reason**:  
Gravastar solutions are unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Generalized dynamical systems are unrelated to the topic.
...
**Title Relevance Reason**:  
Ancient-mineral detection concepts for neutrinos and dark matter are unrelated.
...
**Title Relevance Reason**:  
Black hole perturbations and cosmic censorship are unrelated.
...
**Title Relevance Reason**:  
Gravitational-wave tests of the Kerr hypothesis are unrelated.
...
**Title Relevance Reason**:  
Inflation, reheating, leptogenesis, and dark matter are unrelated.
...
**Title Relevance Reason**:  
Black hole geometry is unrelated.
...
**Title Relevance Reason**:  
Quantum gravity and dark energy are unrelated.
...
**Title Relevance Reason**:  
Relativistic point-particle Lagrangians are unrelated.
...
**Title Relevance Reason**:  
AGN and Hubble constant measurements with EMRIs are unrelated.
...
**Title Relevance Reason**:  
Neutron star equation-of-state observables are unrelated.
...
**Title Relevance Reason**:  
Hybrid inflation parameter scans are unrelated.
...
**Title Relevance Reason**:  
Yukawa gravity detector studies are unrelated.
...
**Title Relevance Reason**:  
Nuclear DFT inference for neutron stars is unrelated.
...
**Title Relevance Reason**:  
Stationary spacetime solutions are unrelated.
...
**Title Relevance Reason**:  
Pair plasma wave interactions are unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Gravitational-wave background anisotropy is unrelated.
...
**Title Relevance Reason**:  
Dark energy theory after DESI is unrelated.
...
**Title Relevance Reason**:  
Euclid angular power spectrum covariances are unrelated.
...
**Title Relevance Reason**:  
Effective field theory in cosmology is unrelated.
...
**Title Relevance Reason**:  
Modified gravity cosmology is unrelated.
...
**Title Relevance Reason**:  
Population III star formation near AGN is unrelated.
...
**Title Relevance Reason**:  
Fiber positioner prototyping is instrumentation unrelated to exoplanet atmosphere studies.
...
**Title Relevance Reason**:  
Gravitational waves and pair-instability mass gap are unrelated.
...
**Title Relevance Reason**:  
Galaxy-shape parity violation is unrelated.
...
**Title Relevance Reason**:  
Interacting dark energy and cosmological constraints are unrelated.
...
**Title Relevance Reason**:  
Pulsar timing array statistics are unrelated.
...
**Title Relevance Reason**:  
Large-scale structure morphology is unrelated.
...
**Title Relevance Reason**:  
Radiation-mediated magnetized shocks are unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
High-frequency primordial gravitational waves are unrelated.
...
**Title Relevance Reason**:  
Distance duality tests in cosmology are unrelated.
...
**Title Relevance Reason**:  
Large-scale structure perturbation theory is unrelated.
...
**Title Relevance Reason**:  
AGN cosmic ray feedback on galaxies is unrelated.
...
**Title Relevance Reason**:  
Solar inertial modes are unrelated.
...
**Title Relevance Reason**:  
Cygnus X-3 gamma-ray emission is unrelated.
...
**Title Relevance Reason**:  
Pulsating star in an eccentric binary is unrelated.
...
**Title Relevance Reason**:  
GREENBURST radio observations are unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
FRB rarity analysis is unrelated.
...
**Title Relevance Reason**:  
Type IIb supernova progenitor analysis is unrelated.
...
**Title Relevance Reason**:  
Galactic cosmic-ray spectra are unrelated.
...
**Title Relevance Reason**:  
Black holes in ultralight dark matter solitons are unrelated.
...
**Title Relevance Reason**:  
Supernova physical properties are unrelated.
...
**Title Relevance Reason**:  
Relativistic turbulence spectra are unrelated.
...
**Title Relevance Reason**:  
Black hole accretion-disk outflows are unrelated.
...
**Title Relevance Reason**:  
LAMOST instrumental profile characterization is unrelated to exoplanet atmosphere studies.
...
**Title Relevance Reason**:  
Foreground bias mitigation for CMB B modes is unrelated.
...
**Title Relevance Reason**:  
Modified gravity forecasts with LSS and CMB lensing are unrelated.
...
**Title Relevance Reason**:  
Flat spectrum radio quasar state transitions are unrelated.
...
**Title Relevance Reason**:  
Magnetic cataclysmic variable light curves are unrelated.
...
**Title Relevance Reason**:  
Her X-1 orbital and spectral evolution is unrelated.
...
**Title Relevance Reason**:  
Population III star cluster simulations are unrelated.
...
**Title Relevance Reason**:  
Massive star-forming cloud collapse is unrelated.
...
**Title Relevance Reason**:  
Primordial black hole cluster evolution is unrelated.
...
**Title Relevance Reason**:  
Gauss-Bonnet inflation is unrelated.
...
**Title Relevance Reason**:  
Little red dot selection effects are unrelated.
...
**Title Relevance Reason**:  
Black hole optical images are unrelated.
...
**Title Relevance Reason**:  
Fisher-matrix validation for gravitational-wave data is unrelated.
...
**Title Relevance Reason**:  
Post-Newtonian black-hole binary dynamics are unrelated.
...
**Title Relevance Reason**:  
Axion-like particles from supernovae are unrelated.
...
**Title Relevance Reason**:  
Leptogenesis and electroweak phase transitions are unrelated.
...
**Title Relevance Reason**:  
DESI cosmology beyond LambdaCDM is unrelated.
...
**Title Relevance Reason**:  
Ionospheric phase structure analysis is unrelated to exoplanet atmosphere studies.
...
**Title Relevance Reason**:  
Astrophysical model comparison for gravitational-wave data is unrelated.
...
**Title Relevance Reason**:  
Axion level crossings are unrelated.
...
**Title Relevance Reason**:  
Black hole instabilities and hair are unrelated.
...
**Title Relevance Reason**:  
Particle scattering by black holes and singularities is unrelated.
...
**Title Relevance Reason**:  
False alarm rates in gravitational-wave lensing are unrelated.
...
**Title Relevance Reason**:  
Solar wind turbulence relations are unrelated.
...
**Title Relevance Reason**:  
Inflation in metric-affine gravity is unrelated.
...
**Title Relevance Reason**:  
Reheating in Weyl-invariant gravity is unrelated.
...
**Title Relevance Reason**:  
Time-delay likelihood structure is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Accelerated time-domain analysis for gravitational-wave astronomy is unrelated.
...
**Title Relevance Reason**:  
Gravitational-wave memory signals are unrelated to the topic.
