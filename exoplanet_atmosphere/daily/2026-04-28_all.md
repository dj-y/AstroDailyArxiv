...
**Title Relevance Reason**:  
Exoplanet spectroscopic sensor concept is relevant to atmospheric characterization instrumentation, though not a direct atmosphere study.
...
**Title Relevance Reason**:  
Radiative transfer in scattering atmospheres is atmospheres-relevant theory, but not clearly about exoplanets or transmission spectroscopy.
...
**Title Relevance Reason**:  
CRIRES+ infrared spectra archive could support high-resolution exoplanet atmosphere spectroscopy, though the title is not exoplanet-specific.
...
**Title Relevance Reason**:  
Exoplanet direct imaging constraints on binary planets and exomoons are planet-focused, but not atmospheric.
...
**Title Relevance Reason**:  
Dynamic exoplanet system orbital evolution is exoplanet-related, but not atmospheric characterization.
...
**Title Relevance Reason**:  
Exoplanet system architecture with warm Jupiter and hot super-Earth is relevant to exoplanets broadly, but not atmospheres.
...
**Title Relevance Reason**:  
Atmospheric dynamics modeling is relevant in a broad sense, but this is about Mars rather than exoplanets.
...
**Title Relevance Reason**:  
Multiplanet system stability after hot Jupiter destruction is relevant to exoplanet systems, but not atmospheres.
...
**Title Relevance Reason**:  
Circumbinary planet formation is exoplanet-related, but not about atmospheres or spectroscopy.
...
**Title Relevance Reason**:  
Ultra-cool brown dwarfs can be atmospheres-adjacent, but this is not about exoplanet atmospheric retrieval or spectroscopy.
...
**Title Relevance Reason**:  
Planet-hosting stars are exoplanet-related, but the focus is stellar activity rather than planetary atmospheres.
...
**Title Relevance Reason**:  
Substellar companions and white dwarf pollution are only loosely adjacent to exoplanet system studies, not atmospheres.
...
**Title Relevance Reason**:  
Elemental abundances of a star can matter for planetary composition context, but this is not an exoplanet atmosphere study.
...
**Title Relevance Reason**:  
Parameter-dependent spectra modeling is methodologically adjacent, but not exoplanet atmosphere-specific.
...
**Title Relevance Reason**:  
Neptunian ridge and tidal migration concern exoplanet population dynamics, but not atmospheric characterization.
...
**Title Relevance Reason**:  
Exocomet light curve work is exoplanet-system adjacent, but not about atmospheres.
...
**Title Relevance Reason**:  
Protoplanetary disk properties are only indirectly relevant through planet formation context, not atmospheres.
...
**Title Relevance Reason**:  
Volatile properties with JWST are somewhat atmospheres-adjacent, but this is about comets, not exoplanets.
...
**Title Relevance Reason**:  
Inner disk structure around a young star is planet-formation adjacent, but not exoplanet atmosphere work.
...
**Title Relevance Reason**:  
Mars moon evolution involves planetary dynamics, not atmospheres or exoplanets.
...
**Title Relevance Reason**:  
JWST observations of main-belt comets involve volatile characterization, but not exoplanet atmospheres.
...
**Title Relevance Reason**:  
Spectral reconstruction of trans-Neptunian objects is spectroscopy-related, but not exoplanet atmospheres.
...
**Title Relevance Reason**:  
Slitless grism spectra framework is a spectroscopy tool, but aimed at galaxies/lenses rather than exoplanet atmospheres.
...
**Title Relevance Reason**:  
Protoplanetary disk substructure study, not focused on exoplanet atmospheres.
...
**Title Relevance Reason**:  
Asteroid spin state is solar system science, not exoplanet atmospheres.
...
**Title Relevance Reason**:  
Interstellar object search context is not about exoplanet atmospheres.
...
**Title Relevance Reason**:  
Oort cloud-like structures and interstellar comets are not relevant to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Spectroscopic modulation of interstellar molecules is chemistry-related but not exoplanet atmospheres.
...
**Title Relevance Reason**:  
JWST magnified stellar events are unrelated despite the JWST keyword.
...
**Title Relevance Reason**:  
Nearby M-dwarf catalog could be tangentially useful for exoplanet host studies, but not about atmospheres.
...
**Title Relevance Reason**:  
AGN disk stellar evolution is unrelated to exoplanet atmosphere studies.
...
**Title Relevance Reason**:  
Pulsar X-ray polarization is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Galaxy simulation methodology for Roman survey is unrelated.
...
**Title Relevance Reason**:  
Dwarf galaxies in clusters are unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Galaxy environment correlations are unrelated.
...
**Title Relevance Reason**:  
AGN outflows are unrelated to exoplanet atmosphere work.
...
**Title Relevance Reason**:  
Supermassive stars and black hole cores are unrelated.
...
**Title Relevance Reason**:  
Type Ia supernova spectral modeling is unrelated.
...
**Title Relevance Reason**:  
Type Ia supernova cosmology is unrelated.
...
**Title Relevance Reason**:  
Young stellar object masses and binaries are unrelated.
...
**Title Relevance Reason**:  
Oort cloud as a primordial black hole detector is unrelated.
...
**Title Relevance Reason**:  
Dark energy evolution is unrelated.
...
**Title Relevance Reason**:  
Perseus cluster gas component study is unrelated.
...
**Title Relevance Reason**:  
Meteor classification is unrelated.
...
**Title Relevance Reason**:  
Kilonova follow-up scoring is unrelated.
...
**Title Relevance Reason**:  
Planetary nebulae research is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Hydrodynamics tracer methodology is unrelated.
...
**Title Relevance Reason**:  
Solar prominence eruption is unrelated.
...
**Title Relevance Reason**:  
Open cluster system analysis is unrelated.
...
**Title Relevance Reason**:  
UHECR associations with radio galaxies are unrelated.
...
**Title Relevance Reason**:  
OB cluster photometric substructure in M31 is unrelated.
...
**Title Relevance Reason**:  
Quasar SED dependence on accretion rate is unrelated.
...
**Title Relevance Reason**:  
Galaxy formation surrogate modeling is unrelated.
...
**Title Relevance Reason**:  
X-ray line modulations in Cyg X-3 are unrelated.
...
**Title Relevance Reason**:  
Detector irradiation campaign is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Preheating in cosmology is unrelated.
...
**Title Relevance Reason**:  
Galaxy and halo luminosity functions are unrelated.
...
**Title Relevance Reason**:  
Submillimeter observation simulator is unrelated.
...
**Title Relevance Reason**:  
Solar filament eruption study is unrelated.
...
**Title Relevance Reason**:  
Scalar field dark matter in M31 is unrelated.
...
**Title Relevance Reason**:  
LIGO scattered light noise analysis is unrelated.
...
**Title Relevance Reason**:  
Modified gravity from cluster kSZ data is unrelated.
...
**Title Relevance Reason**:  
Open-Universe cosmological signal analysis is unrelated.
...
**Title Relevance Reason**:  
Hyperaccreting neutron stars are unrelated.
...
**Title Relevance Reason**:  
Taiji mission magnetic characterization is unrelated.
...
**Title Relevance Reason**:  
Late-time blast waves are unrelated.
...
**Title Relevance Reason**:  
Chameleon gravity constraints from clusters are unrelated.
...
**Title Relevance Reason**:  
Milky Way Mg II gas structure is unrelated.
...
**Title Relevance Reason**:  
Gamma-ray and neutrino source modeling is unrelated.
...
**Title Relevance Reason**:  
Quiet-Sun temperature diagnostic disagreement is unrelated.
...
**Title Relevance Reason**:  
Astronomical light curve classification histories are unrelated.
...
**Title Relevance Reason**:  
Transient optical spectra release is unrelated.
...
**Title Relevance Reason**:  
Faint high-redshift galaxies and reionization are unrelated.
...
**Title Relevance Reason**:  
Cluster galaxy spiral arm mechanisms are unrelated.
...
**Title Relevance Reason**:  
Tidal disruption event simulations are unrelated.
...
**Title Relevance Reason**:  
VLBI astrometry of a star-forming region is unrelated.
...
**Title Relevance Reason**:  
Cosmic expansion reconstruction is unrelated.
...
**Title Relevance Reason**:  
Tianlai operation control system is unrelated.
...
**Title Relevance Reason**:  
Sparse data visualization method is unrelated.
...
**Title Relevance Reason**:  
Hubble constant measurement from BAO is unrelated.
...
**Title Relevance Reason**:  
Galaxy evolution schema and black hole-stellar mass diagrams are unrelated.
...
**Title Relevance Reason**:  
Winged radio galaxies are unrelated.
...
**Title Relevance Reason**:  
Contact binary physical parameters are unrelated.
...
**Title Relevance Reason**:  
21-cm power spectrum limits are unrelated.
...
**Title Relevance Reason**:  
Cosmic web identification from cluster maps is unrelated.
...
**Title Relevance Reason**:  
SOXS spectrograph control software is unrelated.
...
**Title Relevance Reason**:  
SVOM X-ray telescope performance is unrelated.
...
**Title Relevance Reason**:  
SVOM X-ray telescope pipeline is unrelated.
...
**Title Relevance Reason**:  
SVOM visible telescope overview is unrelated.
...
**Title Relevance Reason**:  
SVOM trigger camera is unrelated.
...
**Title Relevance Reason**:  
SVOM science center infrastructure is unrelated.
...
**Title Relevance Reason**:  
SVOM user support services are unrelated.
...
**Title Relevance Reason**:  
SVOM user support is unrelated.
...
**Title Relevance Reason**:  
SVOM detection plane performance is unrelated.
...
**Title Relevance Reason**:  
SVOM analysis pipeline is unrelated.
...
**Title Relevance Reason**:  
SVOM GRB trigger overview is unrelated.
...
**Title Relevance Reason**:  
SVOM calibration analysis is unrelated.
...
**Title Relevance Reason**:  
SVOM mission overview is unrelated.
...
**Title Relevance Reason**:  
SVOM ground support system is unrelated.
...
**Title Relevance Reason**:  
COLIBRI instrumentation for SVOM alerts is unrelated.
...
**Title Relevance Reason**:  
Ground-based wide-angle camera array is unrelated.
...
**Title Relevance Reason**:  
Coded mask for SVOM telescope is unrelated.
...
**Title Relevance Reason**:  
MXT camera in-flight performance is unrelated.
...
**Title Relevance Reason**:  
SVOM VHF alert network is unrelated.
...
**Title Relevance Reason**:  
Alert chain and observation planning for wide-angle cameras are unrelated.
...
**Title Relevance Reason**:  
SVOM response and collaboration system is unrelated.
...
**Title Relevance Reason**:  
SVOM data processing and GRB identification are unrelated.
...
**Title Relevance Reason**:  
GRM scientific pipeline is unrelated.
...
**Title Relevance Reason**:  
SVOM verification and testing are unrelated.
...
**Title Relevance Reason**:  
SVOM onboard data processing is unrelated.
...
**Title Relevance Reason**:  
SVOM on-ground processing is unrelated.
...
**Title Relevance Reason**:  
SVOM instrumentation for alerts is unrelated.
...
**Title Relevance Reason**:  
SVOM GRB joint pipeline is unrelated.
...
**Title Relevance Reason**:  
Coronal loop thermal instability is unrelated.
...
**Title Relevance Reason**:  
Simulation data release is unrelated.
...
**Title Relevance Reason**:  
Chemical tagging of open cluster members is unrelated.
...
**Title Relevance Reason**:  
TANSPEC reduction packages are unrelated.
...
**Title Relevance Reason**:  
Outburst classification of a young stellar object is unrelated.
...
**Title Relevance Reason**:  
Galaxy redshift distribution uncertainties are unrelated.
...
**Title Relevance Reason**:  
CSST galaxy completeness and Sersic fitting are unrelated.
...
**Title Relevance Reason**:  
Relative orbit determination is unrelated.
...
**Title Relevance Reason**:  
Milky Way stellar disk mapping is unrelated.
...
**Title Relevance Reason**:  
Galaxy morphology classification is unrelated.
...
**Title Relevance Reason**:  
Red-giant binary asteroseismology is unrelated.
...
**Title Relevance Reason**:  
Hot gaseous halos of galaxies are unrelated.
...
**Title Relevance Reason**:  
Historical solar eclipse/prominence analysis is unrelated.
...
**Title Relevance Reason**:  
Interstellar benzonitrile in the CMZ is unrelated.
...
**Title Relevance Reason**:  
Contrastive learning for light curves is unrelated.
...
**Title Relevance Reason**:  
Interstellar dust toward GX 13+1 is unrelated.
...
**Title Relevance Reason**:  
Galactic spiral arm distances from dust-scattered X-rays are unrelated.
...
**Title Relevance Reason**:  
Cosmic expansion reconstruction code is unrelated.
...
**Title Relevance Reason**:  
Weyl potential and EG statistic measurement is unrelated.
...
**Title Relevance Reason**:  
Warm inflation module is unrelated.
...
**Title Relevance Reason**:  
Rotating disks in infrared galaxies are unrelated.
...
**Title Relevance Reason**:  
AGN broad-line region modeling is unrelated.
...
**Title Relevance Reason**:  
Planetary nebula candidates and symbiotic stars are unrelated.
...
**Title Relevance Reason**:  
Magnetar burst heavy nuclei evidence is unrelated.
...
**Title Relevance Reason**:  
Local interstellar dust depletion and extinction are unrelated.
...
**Title Relevance Reason**:  
Molecular cloud lifetimes are unrelated.
...
**Title Relevance Reason**:  
Type Ia supernova calibration cosmology is unrelated.
...
**Title Relevance Reason**:  
Autonomous lunar descent framework is unrelated.
...
**Title Relevance Reason**:  
Detector proton irradiation performance is unrelated.
...
**Title Relevance Reason**:  
Massive black hole binary pre-localization is unrelated.
...
**Title Relevance Reason**:  
Scalar polarization tests with multimessenger events are unrelated.
...
**Title Relevance Reason**:  
Vision-language models for astronomy reasoning are unrelated.
...
**Title Relevance Reason**:  
Galactic rotation curves and entropic force are unrelated.
...
**Title Relevance Reason**:  
Host galaxies of massive black hole binaries are unrelated.
...
**Title Relevance Reason**:  
Weak lensing mass map denoising is unrelated.
...
**Title Relevance Reason**:  
Interstellar dust production and depletion in galaxies are unrelated.
...
**Title Relevance Reason**:  
Stochastic inflation is unrelated.
...
**Title Relevance Reason**:  
Kilonovae and long GRBs are unrelated.
...
**Title Relevance Reason**:  
Galaxy formation and black hole seeding are unrelated.
...
**Title Relevance Reason**:  
Lyman-alpha forest and galaxy cross-correlations are unrelated.
...
**Title Relevance Reason**:  
Dark energy constraints are unrelated.
...
**Title Relevance Reason**:  
Planck/ACT cosmology attractor discussion is unrelated.
...
**Title Relevance Reason**:  
Quasar dipole reassessment is unrelated.
...
**Title Relevance Reason**:  
JWST early galaxy tension is unrelated.
...
**Title Relevance Reason**:  
Action-space coherence in Milky Way simulations is unrelated.
...
**Title Relevance Reason**:  
Interacting dark energy and black hole superradiance are unrelated.
...
**Title Relevance Reason**:  
Tachyonic dark energy constraints are unrelated.
...
**Title Relevance Reason**:  
DESI cosmology analysis is unrelated.
...
**Title Relevance Reason**:  
Pulsed radio emission from a compact object is unrelated.
...
**Title Relevance Reason**:  
Type Ia supernova benchmark at high redshift is unrelated.
...
**Title Relevance Reason**:  
AGN disk capture and merger rates are unrelated.
...
**Title Relevance Reason**:  
AGN accretion disk magnetic dominance is unrelated.
...
**Title Relevance Reason**:  
AI understanding in astronomy is unrelated.
...
**Title Relevance Reason**:  
Dark energy and Hubble tension study is unrelated.
...
**Title Relevance Reason**:  
Self-interacting dark matter halo collapse is unrelated.
...
**Title Relevance Reason**:  
Weak lensing multipoles are unrelated.
...
**Title Relevance Reason**:  
Kinematic cosmic dipole is unrelated.
...
**Title Relevance Reason**:  
Analytic cosmology relation from one galaxy is unrelated.
...
**Title Relevance Reason**:  
AGN coronae and diffuse neutrinos are unrelated.
...
**Title Relevance Reason**:  
Fermi-LAT source list is unrelated.
...
**Title Relevance Reason**:  
Dwarf spheroidal galaxy dynamics are unrelated.
...
**Title Relevance Reason**:  
Supernova feedback in galaxy simulations is unrelated.
...
**Title Relevance Reason**:  
Fuzzy dark matter impact on primordial gas is unrelated.
...
**Title Relevance Reason**:  
High-velocity cloud accretion modeling is unrelated.
...
**Title Relevance Reason**:  
Kinematic dataset modeling for the nuclear star cluster is unrelated.
...
**Title Relevance Reason**:  
Cosmic ray electrons in galaxies are unrelated.
...
**Title Relevance Reason**:  
Binary star mass loss is unrelated.
...
**Title Relevance Reason**:  
Accretion flow in AM Herculis is unrelated.
...
**Title Relevance Reason**:  
Common envelope ejection constraints in binaries are unrelated.
...
**Title Relevance Reason**:  
Inelastic self-interacting dark matter cosmology is unrelated.
...
**Title Relevance Reason**:  
Kardashev model falsification is unrelated.
...
**Title Relevance Reason**:  
SVOM detector energy response is unrelated.
...
**Title Relevance Reason**:  
Gamma-ray monitor on SVOM is unrelated.
...
**Title Relevance Reason**:  
Primordial black holes and induced gravitational waves are unrelated.
...
**Title Relevance Reason**:  
Planetary nebula discoveries are unrelated.
...
**Title Relevance Reason**:  
Cosmological gravitational waves from dark matter are unrelated.
...
**Title Relevance Reason**:  
Core-collapse supernova neutrino flux analysis is unrelated.
...
**Title Relevance Reason**:  
Iron line profile from a wormhole is unrelated.
...
**Title Relevance Reason**:  
Solar wind Alfvén wave instability is unrelated.
...
**Title Relevance Reason**:  
Affine gravity cosmology is unrelated.
...
**Title Relevance Reason**:  
Spinfoams and primordial gravitational waves are unrelated.
...
**Title Relevance Reason**:  
Thermal field theory for rotating plasma is unrelated.
...
**Title Relevance Reason**:  
Strong CP symmetry theory is unrelated.
...
**Title Relevance Reason**:  
Magnetic field dynamics with Hall conductivity are unrelated.
...
**Title Relevance Reason**:  
Nonlinear electromagnetic waves in pair plasmas are unrelated.
...
**Title Relevance Reason**:  
Axion dark matter at interferometers is unrelated.
...
**Title Relevance Reason**:  
Self-force waveforms for inspirals are unrelated.
...
**Title Relevance Reason**:  
Dark matter freeze-in from a reheaton is unrelated.
...
**Title Relevance Reason**:  
Extreme-mass ratio inspirals are unrelated.
...
**Title Relevance Reason**:  
Freeze-in dark matter direct detection benchmarks are unrelated.
...
**Title Relevance Reason**:  
Black hole shadow reshaping by a torn disk is unrelated.
