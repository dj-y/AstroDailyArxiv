...
**Title Relevance Reason**:  
High-contrast imaging of forming protoplanets is relevant to exoplanet characterization, though not specifically transmission spectroscopy or retrieval.
...
**Title Relevance Reason**:  
Directly imaged multi-planet system characterization is exoplanet relevant, though not atmosphere-specific.
...
**Title Relevance Reason**:  
Transit light curve analysis of objects orbiting stars is relevant to exoplanet characterization, but not specifically atmospheres.
...
**Title Relevance Reason**:  
Machine learning for exo-planetary science may include atmospheric applications, but the title is broad and not atmosphere-specific.
...
**Title Relevance Reason**:  
Circumbinary planet transit searches are clearly exoplanet related, though not focused on atmospheres.
...
**Title Relevance Reason**:  
Bayesian inference for multiplanet dynamics is relevant to exoplanet systems, but not to atmospheric studies.
...
**Title Relevance Reason**:  
Ultra-short-period planet system architecture is exoplanet related, but not atmosphere focused.
...
**Title Relevance Reason**:  
Transit timing variation masses concern exoplanet characterization, but not atmospheres.
...
**Title Relevance Reason**:  
Nitrogen carriers in inner protoplanetary disks are relevant to volatile inventories, but not directly to exoplanet atmosphere spectroscopy.
...
**Title Relevance Reason**:  
Dust processing in protoplanetary disks is adjacent to planet composition origins, but not atmosphere observations or retrievals.
...
**Title Relevance Reason**:  
JWST/MIRI volatile inventory of an interstellar object involves composition spectroscopy, but not exoplanet atmospheres.
...
**Title Relevance Reason**:  
Polarimetry in planetary science is broadly relevant to planetary characterization, but not specifically exoplanet atmospheres.
...
**Title Relevance Reason**:  
Planetary system formation is broadly exoplanet related, but not atmosphere focused.
...
**Title Relevance Reason**:  
Planetary volatile behavior under Europa-like conditions is tangentially planetary, but not exoplanet atmosphere retrieval or spectroscopy.
...
**Title Relevance Reason**:  
Companion composition inference is planetary/compact-object related, but not exoplanet atmosphere work.
...
**Title Relevance Reason**:  
Ice inventory in a protostellar envelope is astrochemistry related, but not exoplanet atmosphere focused.
...
**Title Relevance Reason**:  
Photoionization and dust grain modeling is spectroscopy-related, but focused on circumstellar nebulae rather than exoplanet atmospheres.
...
**Title Relevance Reason**:  
Terrestrial planet formation is exoplanet-adjacent, but not atmosphere characterization.
...
**Title Relevance Reason**:  
Solid-state chemistry of nitrogen-bearing species is chemically adjacent, but not exoplanet atmosphere focused.
...
**Title Relevance Reason**:  
Uses JWST, but focused on galaxy morphologies rather than exoplanet atmosphere observations.
...
**Title Relevance Reason**:  
Global collisions modeling is about planet formation impacts, not atmospheres.
...
**Title Relevance Reason**:  
Giant planet formation by disk instability is exoplanet related but not atmosphere characterization.
...
**Title Relevance Reason**:  
JWST/MIRI mid-infrared spectroscopy is used, but for a supernova, not exoplanet atmospheres.
...
**Title Relevance Reason**:  
Satellite constellations affect observations broadly, including exoplanet work, but this is not atmosphere-specific.
...
**Title Relevance Reason**:  
Microlensing simulations can relate to exoplanet detection, but not atmospheric studies.
...
**Title Relevance Reason**:  
X-ray lens production is instrumentation for astrophysics, but not relevant to exoplanet atmosphere work.
...
**Title Relevance Reason**:  
Spectrograph design is broadly relevant instrumentation, but not clearly tied to exoplanet atmosphere studies.
...
**Title Relevance Reason**:  
Wavefront sensing instrumentation could be broadly useful for astronomy, but not specifically exoplanet atmospheres.
...
**Title Relevance Reason**:  
Celestial mechanics involving the Earth-Moon system is not relevant to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Wavefront correction instrumentation is broadly astronomical, but not exoplanet atmosphere focused.
...
**Title Relevance Reason**:  
Dark matter halo dynamics in the Local Group; unrelated to exoplanets or atmospheres.
...
**Title Relevance Reason**:  
Gamma-ray sky inference methods; not about exoplanet atmospheres.
...
**Title Relevance Reason**:  
Primordial neutron stars are unrelated to exoplanet atmosphere studies.
...
**Title Relevance Reason**:  
Milky Way circumgalactic medium topic, not exoplanet atmospheres.
...
**Title Relevance Reason**:  
Historical supernova search is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
AGN-driven outflows in a high-redshift galaxy are outside the target topic.
...
**Title Relevance Reason**:  
Asteroid YORP effect is unrelated to exoplanet atmosphere characterization.
...
**Title Relevance Reason**:  
Gamma-ray follow-up of neutron star mergers is unrelated.
...
**Title Relevance Reason**:  
Radio astronomy history paper, not relevant to exoplanet atmospheres.
...
**Title Relevance Reason**:  
IceCube-Gen2 sensor development is unrelated.
...
**Title Relevance Reason**:  
Asteroid orbit determination with Gaia is unrelated.
...
**Title Relevance Reason**:  
Hayabusa2 asteroid flyby mission overview is unrelated.
...
**Title Relevance Reason**:  
Solar coronal mass ejection evolution is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Large-scale structure clustering code is unrelated.
...
**Title Relevance Reason**:  
Cosmological power spectrum and bispectrum analysis is unrelated.
...
**Title Relevance Reason**:  
Dense gas heating in the Galactic Center is unrelated.
...
**Title Relevance Reason**:  
Solar flare cataloging is unrelated to exoplanet atmosphere studies.
...
**Title Relevance Reason**:  
Low surface brightness galaxy evolution is unrelated.
...
**Title Relevance Reason**:  
Pulsar survey paper is unrelated.
...
**Title Relevance Reason**:  
Optical identification of radio sources is unrelated.
...
**Title Relevance Reason**:  
FRB monitoring is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Extragalactic background light measurement is unrelated.
...
**Title Relevance Reason**:  
Axion dark energy is unrelated.
...
**Title Relevance Reason**:  
Cosmic web topology and neutrino mass are unrelated.
...
**Title Relevance Reason**:  
Optical monitoring of a lensed quasar is unrelated.
...
**Title Relevance Reason**:  
High-redshift black hole host galaxy paper is unrelated.
...
**Title Relevance Reason**:  
Chemical abundances in evolved stars are unrelated.
...
**Title Relevance Reason**:  
Planetary nebula detection is unrelated to exoplanets.
...
**Title Relevance Reason**:  
Title is too generic and gives no indication of relevance to exoplanet atmospheres.
...
**Title Relevance Reason**:  
High-redshift quiescent galaxies are unrelated.
...
**Title Relevance Reason**:  
Molecular gas relations in nearby galaxies are unrelated.
...
**Title Relevance Reason**:  
Extragalactic background light determination is unrelated.
...
**Title Relevance Reason**:  
Little Red Dots and nebular continua concern galaxy/AGN science, not exoplanet atmospheres.
...
**Title Relevance Reason**:  
Gamma-ray detector reconstruction is unrelated.
...
**Title Relevance Reason**:  
Lyman-alpha forest EFT compression is unrelated.
...
**Title Relevance Reason**:  
Quasar absorption forest interpretation is unrelated.
...
**Title Relevance Reason**:  
Reionization analog galaxies and DESI spectroscopy are unrelated.
...
**Title Relevance Reason**:  
Lunar regolith search for supernova debris is unrelated.
...
**Title Relevance Reason**:  
Milky Way satellite population is unrelated.
...
**Title Relevance Reason**:  
Fluid dynamics in Taylor-Couette flows is unrelated.
...
**Title Relevance Reason**:  
Ocean bio-optical observations are outside astrophysics and unrelated.
...
**Title Relevance Reason**:  
Compact object tidal properties are unrelated.
...
**Title Relevance Reason**:  
Modified gravity theory is unrelated.
...
**Title Relevance Reason**:  
Tidal response of compact objects is unrelated.
...
**Title Relevance Reason**:  
LIGO glitch classification is unrelated.
...
**Title Relevance Reason**:  
Machine learning for gravitational wave inference is unrelated.
...
**Title Relevance Reason**:  
Loop quantum cosmology topic is unrelated.
...
**Title Relevance Reason**:  
LISA kinematic dipole analysis is unrelated.
...
**Title Relevance Reason**:  
Accretion disk magnification factors are unrelated.
...
**Title Relevance Reason**:  
Scalar-tensor gravity theory is unrelated.
...
**Title Relevance Reason**:  
Plasma evolution and magnetogenesis are unrelated.
...
**Title Relevance Reason**:  
Solar symmetron direct detection is unrelated.
...
**Title Relevance Reason**:  
CMB dark radiation signatures are unrelated.
...
**Title Relevance Reason**:  
Little Red Dot AGN spectroscopy is unrelated.
...
**Title Relevance Reason**:  
Solar flare energetics paper is unrelated.
...
**Title Relevance Reason**:  
Galaxy formation and Milky Way disk evolution are unrelated.
...
**Title Relevance Reason**:  
Lensed supernova time delays and H0 estimation are unrelated.
...
**Title Relevance Reason**:  
Nonlinear matter power spectrum simulations are unrelated.
...
**Title Relevance Reason**:  
Dark matter wakes in large-scale structure are unrelated.
...
**Title Relevance Reason**:  
Galaxy morphology bias correction is unrelated.
...
**Title Relevance Reason**:  
X-ray binary outburst evolution is unrelated.
...
**Title Relevance Reason**:  
Black hole synchrotron emission and polarization are unrelated.
...
**Title Relevance Reason**:  
High-energy neutrinos from a nova are unrelated.
...
**Title Relevance Reason**:  
Satellite lifetime prediction validation is unrelated.
...
**Title Relevance Reason**:  
High-redshift AGN in bursty galaxies are unrelated.
...
**Title Relevance Reason**:  
Stellar spectra parameter inference is unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Galaxy baryon budget in the early universe is unrelated.
...
**Title Relevance Reason**:  
Giant radio source formation is unrelated.
...
**Title Relevance Reason**:  
Solar corona and heliosphere magnetic connectivity are unrelated.
...
**Title Relevance Reason**:  
Galaxy power spectrum and bispectrum modeling are unrelated.
...
**Title Relevance Reason**:  
Strong lens spectroscopic redshifts are unrelated.
...
**Title Relevance Reason**:  
Cosmological phase transitions and gravitational waves are unrelated.
...
**Title Relevance Reason**:  
Black-hole binary spin precession is unrelated.
...
**Title Relevance Reason**:  
Solar wind turbulence characterization is unrelated to exoplanet atmospheres.
