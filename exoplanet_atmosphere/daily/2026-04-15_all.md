...
**Title Relevance Reason**:  
Cloudy substellar atmospheres and JWST/MIRI are relevant, though this is broader substellar atmosphere work rather than specifically exoplanet transmission/retrieval.
...
**Title Relevance Reason**:  
Planetary composition and envelopes in Uranus and Neptune are somewhat adjacent to atmosphere studies, but not clearly about exoplanet atmospheres or spectroscopy.
...
**Title Relevance Reason**:  
Atmospheric/auroral ionization in Ganymede is planetary atmosphere related, but not exoplanet atmosphere work.
...
**Title Relevance Reason**:  
JWST/MIRI with hydrocarbon and water absorption is chemically adjacent, but this is about a young disk wind, not an exoplanet atmosphere.
...
**Title Relevance Reason**:  
A known exoplanet system is involved, but the paper is about orbital perturbations, not atmospheric observations or modeling.
...
**Title Relevance Reason**:  
A planet-focused title with observational implications, but centered on dark matter heating of Planet 9 rather than atmospheres.
...
**Title Relevance Reason**:  
Moons and exomoons are planetary topics, but the title is not focused on exoplanet atmospheres.
...
**Title Relevance Reason**:  
Chemical analysis of asteroid organics is solar system chemistry, only loosely related to atmospheric composition themes.
...
**Title Relevance Reason**:  
Planetary formation in the inner Solar System; tangentially relevant to planets but not atmospheres.
...
**Title Relevance Reason**:  
Planetary interior/lunar core chemistry is planetary science, but not atmosphere focused.
...
**Title Relevance Reason**:  
Radiative transfer code could be methodologically relevant, but the title is generic and not targeted to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Radiative transfer and dust/gas modeling are methodologically adjacent, but this is about galaxies, not exoplanet atmospheres.
...
**Title Relevance Reason**:  
Planet formation and dust traps in protoplanetary discs; only indirectly related to exoplanets.
...
**Title Relevance Reason**:  
JWST/MIRI and dust chemistry are somewhat adjacent, but this is about protostellar jets, not exoplanet atmospheres.
...
**Title Relevance Reason**:  
Circumbinary orbit stability is planetary-system related, but not about atmospheres.
...
**Title Relevance Reason**:  
JWST and dust are relevant terms, but this is about a starburst galaxy wind, not exoplanet atmospheres.
...
**Title Relevance Reason**:  
JWST and carbonaceous emission bands are mentioned, but this is about photodissociation regions, not exoplanet atmospheres.
...
**Title Relevance Reason**:  
JWST observations appear, but the paper is about a lensed Type Ia supernova, not exoplanet atmospheres.
...
**Title Relevance Reason**:  
Nuclear dust in AGN; only a weak keyword overlap with dust/clouds, otherwise unrelated.
...
**Title Relevance Reason**:  
Neutron star oscillations; unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Black hole imaging from GRMHD simulations; unrelated topic.
...
**Title Relevance Reason**:  
Supermassive black hole binary analysis; unrelated.
...
**Title Relevance Reason**:  
Radio galaxy jet spectral evolution; unrelated.
...
**Title Relevance Reason**:  
Dusty star-forming galaxies survey; unrelated.
...
**Title Relevance Reason**:  
Galactic radio transients; unrelated.
...
**Title Relevance Reason**:  
Type Ia supernova datasets and dark energy; unrelated.
...
**Title Relevance Reason**:  
Supernova yield ratios and timescales; unrelated.
...
**Title Relevance Reason**:  
Dark matter halo perturbations in galaxies; unrelated.
...
**Title Relevance Reason**:  
CMB polarization ratio origin; unrelated.
...
**Title Relevance Reason**:  
Post-starburst galaxy and ram-pressure stripping; unrelated.
...
**Title Relevance Reason**:  
High-redshift galaxy CIII] emission and outflows; unrelated.
...
**Title Relevance Reason**:  
Galaxy kinematic disturbance parameter; unrelated.
...
**Title Relevance Reason**:  
FS CMa stars and mergers; unrelated.
...
**Title Relevance Reason**:  
Gravitational lens modeling; unrelated.
...
**Title Relevance Reason**:  
RR Lyrae in an open cluster; unrelated.
...
**Title Relevance Reason**:  
Chemical enrichment in disc galaxies; unrelated.
...
**Title Relevance Reason**:  
Runaway stars in an OB association; unrelated.
...
**Title Relevance Reason**:  
Coupled dark energy constraints; unrelated.
...
**Title Relevance Reason**:  
Radio galaxy spectral mapping; unrelated.
...
**Title Relevance Reason**:  
Simulated galaxy perturbation growth; unrelated.
...
**Title Relevance Reason**:  
Stellar astrophysical parameters; unrelated.
...
**Title Relevance Reason**:  
Accretion disk instability in cataclysmic variables; unrelated.
...
**Title Relevance Reason**:  
Changing-look AGN identification; unrelated.
...
**Title Relevance Reason**:  
Red giant convection and mixing; unrelated.
...
**Title Relevance Reason**:  
General theoretical problem unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Lens galaxy kinematics and dynamics; unrelated.
...
**Title Relevance Reason**:  
Dark matter halos probed with FRBs; unrelated.
...
**Title Relevance Reason**:  
21 cm power spectrum observations; unrelated.
...
**Title Relevance Reason**:  
Detector array spatial mapping; unrelated.
...
**Title Relevance Reason**:  
Fast radio transient detection and inference; unrelated.
...
**Title Relevance Reason**:  
Solar flare white-light emission; unrelated.
...
**Title Relevance Reason**:  
Variable star characterization; unrelated.
...
**Title Relevance Reason**:  
Ly-alpha emitter identification; unrelated.
...
**Title Relevance Reason**:  
AGN accretion-mode transitions; unrelated.
...
**Title Relevance Reason**:  
Stellar system solution; unrelated.
...
**Title Relevance Reason**:  
Blue straggler stars in a cluster; unrelated.
...
**Title Relevance Reason**:  
Type Ibn supernova and PeVatron candidate; unrelated.
...
**Title Relevance Reason**:  
Shock-wave precursor instability; unrelated.
...
**Title Relevance Reason**:  
Massive protostar evidence; unrelated.
...
**Title Relevance Reason**:  
AGB object chemistry and morphokinematics; unrelated to exoplanets.
...
**Title Relevance Reason**:  
Supernova magnitude transition and cosmology; unrelated.
...
**Title Relevance Reason**:  
Kelvin waves in rotating shells; unrelated.
...
**Title Relevance Reason**:  
Metal enrichment in a galaxy group; unrelated.
...
**Title Relevance Reason**:  
Dark matter effects on massive black hole binaries; unrelated.
...
**Title Relevance Reason**:  
MHD simulation code for stellar astrophysics; unrelated.
...
**Title Relevance Reason**:  
Undetectable core-collapse supernovae; unrelated.
...
**Title Relevance Reason**:  
Self-lensing in compact binaries; unrelated.
...
**Title Relevance Reason**:  
Large-scale structure from supernovae; unrelated.
...
**Title Relevance Reason**:  
Solar energetic electrons and microflares; unrelated.
...
**Title Relevance Reason**:  
TESS variability classification catalog; unrelated.
...
**Title Relevance Reason**:  
Persistent radio source spectrum near an FRB; unrelated.
...
**Title Relevance Reason**:  
CME evolution and wave-trains; unrelated.
...
**Title Relevance Reason**:  
Formation of Gaia black holes; unrelated.
...
**Title Relevance Reason**:  
Black hole progenitors; unrelated.
...
**Title Relevance Reason**:  
R-process abundances in metal-poor stars; unrelated.
...
**Title Relevance Reason**:  
Angular size-redshift cosmological test; unrelated.
...
**Title Relevance Reason**:  
Wolf-Rayet star bubble high-energy processes; unrelated.
...
**Title Relevance Reason**:  
JWST little red dots; galaxy/AGN topic, unrelated.
...
**Title Relevance Reason**:  
Mathematical note unrelated to exoplanet atmospheres.
...
**Title Relevance Reason**:  
Antenna/phased array analysis; unrelated.
...
**Title Relevance Reason**:  
History of astronomy; unrelated.
...
**Title Relevance Reason**:  
Black hole signatures and QPOs; unrelated.
...
**Title Relevance Reason**:  
Hypersonic air-flow radiation prediction; not astrophysical exoplanet atmosphere work.
...
**Title Relevance Reason**:  
GW detector localization baselines; unrelated.
...
**Title Relevance Reason**:  
Ringdown tests of GR; unrelated.
...
**Title Relevance Reason**:  
Binary inspiral waveform model; unrelated.
...
**Title Relevance Reason**:  
Solar wind and CME observations; unrelated.
...
**Title Relevance Reason**:  
Graviton production in the early universe; unrelated.
...
**Title Relevance Reason**:  
Dark sector theory and galactic acceleration scale; unrelated.
...
**Title Relevance Reason**:  
Black hole accretion flow spectral states; unrelated.
...
**Title Relevance Reason**:  
Quasar photometric redshifts; unrelated.
...
**Title Relevance Reason**:  
Cosmic birefringence; unrelated.
...
**Title Relevance Reason**:  
Dark matter halo phase-space densities; unrelated.
...
**Title Relevance Reason**:  
LAMOST quasar survey; unrelated.
...
**Title Relevance Reason**:  
Dark energy EFT reconstruction; unrelated.
...
**Title Relevance Reason**:  
Jets in Type Ic supernovae; unrelated.
...
**Title Relevance Reason**:  
Rotation-magnetism in solar-type stars; unrelated.
...
**Title Relevance Reason**:  
Binary black hole merger rate evolution; unrelated.
...
**Title Relevance Reason**:  
GN-z11 metal pollution; unrelated.
...
**Title Relevance Reason**:  
Type IIn supernova progenitors; unrelated.
...
**Title Relevance Reason**:  
Signal processing language and HDL generation; unrelated.
...
**Title Relevance Reason**:  
Pair-instability mass cutoff with gravitational waves; unrelated.
...
**Title Relevance Reason**:  
Stripped low-mass stars and Gaia implications; unrelated.
...
**Title Relevance Reason**:  
Euclid galaxy cluster candidate; unrelated.
...
**Title Relevance Reason**:  
Comment on slow-roll cosmology corrections; unrelated.
...
**Title Relevance Reason**:  
Globular cluster dating via brown dwarf cooling; unrelated.
...
**Title Relevance Reason**:  
Wide binaries in star clusters; unrelated.
...
**Title Relevance Reason**:  
Stellar populations in Terzan 5; unrelated.
...
**Title Relevance Reason**:  
AI-assisted decomposition of gravitational lenses; unrelated.
...
**Title Relevance Reason**:  
Euclid source classification and redshifts; unrelated.
...
**Title Relevance Reason**:  
Quasar flare detection with AI; unrelated.
...
**Title Relevance Reason**:  
Molecular layering in a dusty streamer; unrelated.
...
**Title Relevance Reason**:  
Dark universe test through Layzer-Irvine equation; unrelated.
...
**Title Relevance Reason**:  
Maxwell-Bloch equations with astrophysical applications; unrelated by title.
...
**Title Relevance Reason**:  
Dark energy and holography; unrelated.
...
**Title Relevance Reason**:  
Post-merger gravitational wave searches; unrelated.
...
**Title Relevance Reason**:  
Photon propagation through magnetar-hosted axion clouds; unrelated.
